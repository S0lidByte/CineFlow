...
class PersonChanges200Response(BaseModel):
    """
    PersonChanges200Response
    """  # noqa: E501

    changes: Optional[List[PersonChanges200ResponseChangesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "changes": (
                    [
                        PersonChanges200ResponseChangesInner.from_dict(_item)
