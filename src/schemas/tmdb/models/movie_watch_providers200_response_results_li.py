...
class MovieWatchProviders200ResponseResultsLI(BaseModel):
    """
    MovieWatchProviders200ResponseResultsLI
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsLIFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsLIFlatrateInner.from_dict(
                            _item
                        )
