...
class CollectionTranslations200ResponseTranslationsInner(BaseModel):
    """
    ...
    data: Optional[CollectionTranslations200ResponseTranslationsInnerData] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    CollectionTranslations200ResponseTranslationsInnerData.from_dict(
                        obj["data"]
                    )
