...
class TvSeriesTranslations200ResponseTranslationsInner(BaseModel):
    """
    ...
    data: Optional[TvSeriesTranslations200ResponseTranslationsInnerData] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    TvSeriesTranslations200ResponseTranslationsInnerData.from_dict(
                        obj["data"]
                    )
