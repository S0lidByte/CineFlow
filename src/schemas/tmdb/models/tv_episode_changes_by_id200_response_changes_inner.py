...
class TvEpisodeChangesById200ResponseChangesInner(BaseModel):
    """
    TvEpisodeChangesById200ResponseChangesInner
    """  # noqa: E501

    key: Optional[StrictStr] = None
    items: Optional[List[TvEpisodeChangesById200ResponseChangesInnerItemsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        TvEpisodeChangesById200ResponseChangesInnerItemsInner.from_dict(
                            _item
                        )
