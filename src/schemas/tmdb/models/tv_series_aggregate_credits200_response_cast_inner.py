...
class TvSeriesAggregateCredits200ResponseCastInner(BaseModel):
    """
    ...
    roles: Optional[List[TvSeriesAggregateCredits200ResponseCastInnerRolesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "roles": (
                    [
                        TvSeriesAggregateCredits200ResponseCastInnerRolesInner.from_dict(
                            _item
                        )
