...
class TvSeriesWatchProviders200ResponseResultsGF(BaseModel):
    """
    TvSeriesWatchProviders200ResponseResultsGF
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsGFFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsGFFlatrateInner.from_dict(
                            _item
                        )
