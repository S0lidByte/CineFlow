...
class TvSeriesWatchProviders200ResponseResultsPT(BaseModel):
    """
    TvSeriesWatchProviders200ResponseResultsPT
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsBBFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsBBFlatrateInner.from_dict(
                            _item
                        )
