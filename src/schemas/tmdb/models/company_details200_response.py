...
class CompanyDetails200Response(BaseModel):
    """
    ...
    parent_company: Optional[Any] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if parent_company (nullable) is None
        # and model_fields_set contains the field
        if self.parent_company is None and "parent_company" in self.model_fields_set:
            _dict["parent_company"] = None
