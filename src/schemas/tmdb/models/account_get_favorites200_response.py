...
class AccountGetFavorites200Response(BaseModel):
    """
    AccountGetFavorites200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[AccountGetFavorites200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        AccountGetFavorites200ResponseResultsInner.from_dict(_item)
