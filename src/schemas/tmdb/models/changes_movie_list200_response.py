...
class ChangesMovieList200Response(BaseModel):
    """
    ChangesMovieList200Response
    """  # noqa: E501

    results: Optional[List[ChangesMovieList200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "results": (
                    [
                        ChangesMovieList200ResponseResultsInner.from_dict(_item)
