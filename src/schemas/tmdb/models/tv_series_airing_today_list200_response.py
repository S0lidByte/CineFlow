...
class TvSeriesAiringTodayList200Response(BaseModel):
    """
    TvSeriesAiringTodayList200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[TvSeriesAiringTodayList200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeriesAiringTodayList200ResponseResultsInner.from_dict(_item)
