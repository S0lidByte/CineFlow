...
class TvSeriesAlternativeTitles200Response(BaseModel):
    """
    TvSeriesAlternativeTitles200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[List[TvSeriesAlternativeTitles200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeriesAlternativeTitles200ResponseResultsInner.from_dict(
                            _item
                        )
