...
class TvSeriesScreenedTheatrically200Response(BaseModel):
    """
    TvSeriesScreenedTheatrically200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[List[TvSeriesScreenedTheatrically200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeriesScreenedTheatrically200ResponseResultsInner.from_dict(
                            _item
                        )
