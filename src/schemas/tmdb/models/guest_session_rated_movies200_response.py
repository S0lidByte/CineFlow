...
class GuestSessionRatedMovies200Response(BaseModel):
    """
    GuestSessionRatedMovies200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[GuestSessionRatedMovies200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        GuestSessionRatedMovies200ResponseResultsInner.from_dict(_item)
