...
class TvSeriesReviews200Response(BaseModel):
    """
    ...
    results: Optional[List[TvSeriesReviews200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeriesReviews200ResponseResultsInner.from_dict(_item)
