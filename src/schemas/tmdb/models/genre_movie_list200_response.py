...
class GenreMovieList200Response(BaseModel):
    """
    GenreMovieList200Response
    """  # noqa: E501

    genres: Optional[List[GenreMovieList200ResponseGenresInner]] = None
    __properties: ClassVar[List[str]] = ["genres"]
        ...
        _obj = cls.model_validate(
            {
                "genres": (
                    [
                        GenreMovieList200ResponseGenresInner.from_dict(_item)
