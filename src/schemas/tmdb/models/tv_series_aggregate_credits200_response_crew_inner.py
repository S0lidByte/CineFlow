...
class TvSeriesAggregateCredits200ResponseCrewInner(BaseModel):
    """
    ...
    jobs: Optional[List[TvSeriesAggregateCredits200ResponseCrewInnerJobsInner]] = None
    department: Optional[StrictStr] = None
    total_episode_count: Optional[StrictInt] = 0
        ...
        _obj = cls.model_validate(
            {
                ...
                "jobs": (
                    [
                        TvSeriesAggregateCredits200ResponseCrewInnerJobsInner.from_dict(
                            _item
                        )
                        for _item in obj["jobs"]
                    ]
                ...
                "total_episode_count": (
                    obj.get("total_episode_count")
                    if obj.get("total_episode_count") is not None
                    else 0
                ),
            }
        )
