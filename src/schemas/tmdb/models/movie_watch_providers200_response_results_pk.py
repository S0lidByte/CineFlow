...
class MovieWatchProviders200ResponseResultsPK(BaseModel):
    """
    MovieWatchProviders200ResponseResultsPK
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsPKFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsPKFlatrateInner.from_dict(
                            _item
                        )
