...
class MovieReleaseDates200Response(BaseModel):
    """
    MovieReleaseDates200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[List[MovieReleaseDates200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        MovieReleaseDates200ResponseResultsInner.from_dict(_item)
