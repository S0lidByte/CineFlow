...
class MovieExternalIds200Response(BaseModel):
    """
    ...
    wikidata_id: Optional[Any] = None
    facebook_id: Optional[StrictStr] = None
    instagram_id: Optional[Any] = None
    twitter_id: Optional[Any] = None
