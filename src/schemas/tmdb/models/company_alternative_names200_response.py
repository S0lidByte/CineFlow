...
class CompanyAlternativeNames200Response(BaseModel):
    """
    CompanyAlternativeNames200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[List[CompanyAlternativeNames200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        CompanyAlternativeNames200ResponseResultsInner.from_dict(_item)
