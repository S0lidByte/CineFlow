...
class MovieWatchProviders200ResponseResultsTH(BaseModel):
    """
    MovieWatchProviders200ResponseResultsTH
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsMYFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsMYFlatrateInner.from_dict(
                            _item
                        )
