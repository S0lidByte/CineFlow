...
class TvSeriesWatchProviders200ResponseResultsCZ(BaseModel):
    """
    ...
    flatrate: Optional[
        List[TvSeriesWatchProviders200ResponseResultsCZFlatrateInner]
    ] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        TvSeriesWatchProviders200ResponseResultsCZFlatrateInner.from_dict(
                            _item
                        )
