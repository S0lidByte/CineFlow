...
class Translations200ResponseTranslationsInnerData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["biography", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"biography": obj.get("biography"), "name": obj.get("name")}
        )
        return _obj
