...
class PersonCombinedCredits200Response(BaseModel):
    """
    PersonCombinedCredits200Response
    """  # noqa: E501

    cast: Optional[List[PersonCombinedCredits200ResponseCastInner]] = None
    crew: Optional[List[PersonCombinedCredits200ResponseCrewInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "cast": (
                    [
                        PersonCombinedCredits200ResponseCastInner.from_dict(_item)
                ...
                "crew": (
                    [
                        PersonCombinedCredits200ResponseCrewInner.from_dict(_item)
