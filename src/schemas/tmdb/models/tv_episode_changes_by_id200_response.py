...
class TvEpisodeChangesById200Response(BaseModel):
    """
    TvEpisodeChangesById200Response
    """  # noqa: E501

    changes: Optional[List[TvEpisodeChangesById200ResponseChangesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "changes": (
                    [
                        TvEpisodeChangesById200ResponseChangesInner.from_dict(_item)
                        for _item in obj["changes"]
                    ]
