...
class TvSeriesRecommendations200Response(BaseModel):
    """
    TvSeriesRecommendations200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[TvSeriesRecommendations200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeriesRecommendations200ResponseResultsInner.from_dict(_item)
