...
class TrendingPeople200ResponseResultsInner(BaseModel):
    """
    ...
    known_for: Optional[List[TrendingPeople200ResponseResultsInnerKnownForInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "known_for": (
                    [
                        TrendingPeople200ResponseResultsInnerKnownForInner.from_dict(
                            _item
                        )
