...
class TvSeriesWatchProviders200ResponseResultsMU(BaseModel):
    """
    ...
    flatrate: Optional[
        List[TvSeriesWatchProviders200ResponseResultsMUFlatrateInner]
    ] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        TvSeriesWatchProviders200ResponseResultsMUFlatrateInner.from_dict(
                            _item
                        )
