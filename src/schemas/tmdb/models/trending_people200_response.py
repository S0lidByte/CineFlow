...
class TrendingPeople200Response(BaseModel):
    """
    TrendingPeople200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[TrendingPeople200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TrendingPeople200ResponseResultsInner.from_dict(_item)
