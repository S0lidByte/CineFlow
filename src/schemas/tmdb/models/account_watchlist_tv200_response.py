...
class AccountWatchlistTv200Response(BaseModel):
    """
    AccountWatchlistTv200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[AccountWatchlistTv200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        AccountWatchlistTv200ResponseResultsInner.from_dict(_item)
