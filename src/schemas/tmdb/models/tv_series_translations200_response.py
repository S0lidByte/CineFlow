...
class TvSeriesTranslations200Response(BaseModel):
    """
    TvSeriesTranslations200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    translations: Optional[List[TvSeriesTranslations200ResponseTranslationsInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "translations": (
                    [
                        TvSeriesTranslations200ResponseTranslationsInner.from_dict(
                            _item
                        )
