...
class TvSeasonWatchProviders200Response(BaseModel):
    """
    TvSeasonWatchProviders200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[TvSeasonWatchProviders200ResponseResults] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    TvSeasonWatchProviders200ResponseResults.from_dict(obj["results"])
