...
class PersonImages200Response(BaseModel):
    """
    PersonImages200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    profiles: Optional[List[PersonImages200ResponseProfilesInner]] = None
    __properties: ClassVar[List[str]] = ["id", "profiles"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "profiles": (
                    [
                        PersonImages200ResponseProfilesInner.from_dict(_item)
