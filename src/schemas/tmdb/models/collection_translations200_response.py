...
class CollectionTranslations200Response(BaseModel):
    """
    CollectionTranslations200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    translations: Optional[List[CollectionTranslations200ResponseTranslationsInner]] = (
        None
    )
    __properties: ClassVar[List[str]] = ["id", "translations"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "translations": (
                    [
                        CollectionTranslations200ResponseTranslationsInner.from_dict(
                            _item
                        )
                        for _item in obj["translations"]
                    ]
