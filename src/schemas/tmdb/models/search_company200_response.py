...
class SearchCompany200Response(BaseModel):
    """
    SearchCompany200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[SearchCompany200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        SearchCompany200ResponseResultsInner.from_dict(_item)
