...
class TvSeasonWatchProviders200ResponseResultsEG(BaseModel):
    """
    ...
    flatrate: Optional[
        List[TvSeasonWatchProviders200ResponseResultsEGFlatrateInner]
    ] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        TvSeasonWatchProviders200ResponseResultsEGFlatrateInner.from_dict(
                            _item
                        )
