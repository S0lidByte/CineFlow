...
class PersonExternalIds200Response(BaseModel):
    """
    ...
    tvrage_id: Optional[StrictInt] = 0
    wikidata_id: Optional[StrictStr] = None
    facebook_id: Optional[StrictStr] = None
    instagram_id: Optional[StrictStr] = None
    tiktok_id: Optional[StrictStr] = None
    twitter_id: Optional[StrictStr] = None
    youtube_id: Optional[Any] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "tvrage_id": (
                    obj.get("tvrage_id") if obj.get("tvrage_id") is not None else 0
                ),
                "wikidata_id": obj.get("wikidata_id"),
                "facebook_id": obj.get("facebook_id"),
                "instagram_id": obj.get("instagram_id"),
                "tiktok_id": obj.get("tiktok_id"),
