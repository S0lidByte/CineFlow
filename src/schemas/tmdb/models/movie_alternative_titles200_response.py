...
class MovieAlternativeTitles200Response(BaseModel):
    """
    MovieAlternativeTitles200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    titles: Optional[List[MovieAlternativeTitles200ResponseTitlesInner]] = None
    __properties: ClassVar[List[str]] = ["id", "titles"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "titles": (
                    [
                        MovieAlternativeTitles200ResponseTitlesInner.from_dict(_item)
                        for _item in obj["titles"]
                    ]
                    if obj.get("titles") is not None
                    else None
                ),
            }
        )
