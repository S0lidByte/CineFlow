...
class AccountRatedTv200Response(BaseModel):
    """
    AccountRatedTv200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[AccountRatedTv200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        AccountRatedTv200ResponseResultsInner.from_dict(_item)
