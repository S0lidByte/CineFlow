...
class TvSeriesWatchProviders200ResponseResultsIE(BaseModel):
    """
    ...
    buy: Optional[List[TvSeriesWatchProviders200ResponseResultsIEBuyInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "buy": (
                    [
                        TvSeriesWatchProviders200ResponseResultsIEBuyInner.from_dict(
                            _item
                        )
