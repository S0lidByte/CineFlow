...
class TvSeriesChanges200Response(BaseModel):
    """
    TvSeriesChanges200Response
    """  # noqa: E501

    changes: Optional[List[TvSeriesChanges200ResponseChangesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "changes": (
                    [
                        TvSeriesChanges200ResponseChangesInner.from_dict(_item)
