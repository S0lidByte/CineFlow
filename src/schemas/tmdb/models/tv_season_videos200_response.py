...
class TvSeasonVideos200Response(BaseModel):
    """
    TvSeasonVideos200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[List[TvSeasonVideos200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeasonVideos200ResponseResultsInner.from_dict(_item)
