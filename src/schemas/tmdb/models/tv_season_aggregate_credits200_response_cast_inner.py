...
class TvSeasonAggregateCredits200ResponseCastInner(BaseModel):
    """
    ...
    roles: Optional[List[TvSeasonAggregateCredits200ResponseCastInnerRolesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "roles": (
                    [
                        TvSeasonAggregateCredits200ResponseCastInnerRolesInner.from_dict(
                            _item
                        )
