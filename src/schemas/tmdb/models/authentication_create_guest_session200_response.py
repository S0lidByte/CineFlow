...
class AuthenticationCreateGuestSession200Response(BaseModel):
    """
    AuthenticationCreateGuestSession200Response
    """  # noqa: E501

    success: Optional[StrictBool] = True
    guest_session_id: Optional[StrictStr] = None
    expires_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["success", "guest_session_id", "expires_at"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "guest_session_id": obj.get("guest_session_id"),
