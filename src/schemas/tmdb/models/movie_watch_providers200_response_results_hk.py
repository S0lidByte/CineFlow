...
class MovieWatchProviders200ResponseResultsHK(BaseModel):
    """
    MovieWatchProviders200ResponseResultsHK
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsHKFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsHKFlatrateInner.from_dict(
                            _item
                        )
