...
class MovieReviews200ResponseResultsInner(BaseModel):
    """
    MovieReviews200ResponseResultsInner
    """  # noqa: E501

    author: Optional[StrictStr] = None
    author_details: Optional[MovieReviews200ResponseResultsInnerAuthorDetails] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "author_details": (
                    MovieReviews200ResponseResultsInnerAuthorDetails.from_dict(
                        obj["author_details"]
                    )
