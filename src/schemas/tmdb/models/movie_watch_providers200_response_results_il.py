...
class MovieWatchProviders200ResponseResultsIL(BaseModel):
    """
    MovieWatchProviders200ResponseResultsIL
    """  # noqa: E501

    link: Optional[StrictStr] = None
    buy: Optional[List[MovieWatchProviders200ResponseResultsILBuyInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "buy": (
                    [
                        MovieWatchProviders200ResponseResultsILBuyInner.from_dict(_item)
