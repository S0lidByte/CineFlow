...
class TvSeriesChanges200ResponseChangesInner(BaseModel):
    """
    TvSeriesChanges200ResponseChangesInner
    """  # noqa: E501

    key: Optional[StrictStr] = None
    items: Optional[List[TvSeriesChanges200ResponseChangesInnerItemsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        TvSeriesChanges200ResponseChangesInnerItemsInner.from_dict(
                            _item
                        )
