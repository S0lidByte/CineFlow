...
class TvSeriesWatchProviders200ResponseResultsTW(BaseModel):
    """
    ...
    flatrate: Optional[
        List[TvSeriesWatchProviders200ResponseResultsHKFlatrateInner]
    ] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        TvSeriesWatchProviders200ResponseResultsHKFlatrateInner.from_dict(
                            _item
                        )
