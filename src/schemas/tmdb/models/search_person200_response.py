...
class SearchPerson200Response(BaseModel):
    """
    SearchPerson200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[SearchPerson200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        SearchPerson200ResponseResultsInner.from_dict(_item)
