...
class TvSeriesChanges200ResponseChangesInnerItemsInnerOriginalValuePoster(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["file_path", "iso_639_1"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"file_path": obj.get("file_path"), "iso_639_1": obj.get("iso_639_1")}
        )
        return _obj
