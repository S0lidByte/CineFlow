...
class TvSeriesWatchProviders200ResponseResultsFI(BaseModel):
    """
    TvSeriesWatchProviders200ResponseResultsFI
    """  # noqa: E501

    link: Optional[StrictStr] = None
    buy: Optional[List[TvSeriesWatchProviders200ResponseResultsFIBuyInner]] = None
    flatrate: Optional[
        ...
        _obj = cls.model_validate(
            {
                ...
                "buy": (
                    [
                        TvSeriesWatchProviders200ResponseResultsFIBuyInner.from_dict(
                            _item
                        )
