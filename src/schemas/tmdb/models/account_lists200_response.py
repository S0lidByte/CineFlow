...
class AccountLists200Response(BaseModel):
    """
    AccountLists200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[AccountLists200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        AccountLists200ResponseResultsInner.from_dict(_item)
