...
class Translations200ResponseTranslationsInner(BaseModel):
    """
    ...
    data: Optional[Translations200ResponseTranslationsInnerData] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    Translations200ResponseTranslationsInnerData.from_dict(obj["data"])
