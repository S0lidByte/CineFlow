...
class AuthenticationCreateSessionFromLogin200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["success", "expires_at", "request_token"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "request_token": obj.get("request_token"),
            }
        )
        return _obj
