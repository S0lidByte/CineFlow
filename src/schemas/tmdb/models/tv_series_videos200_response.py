...
class TvSeriesVideos200Response(BaseModel):
    """
    TvSeriesVideos200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[List[TvSeriesVideos200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeriesVideos200ResponseResultsInner.from_dict(_item)
