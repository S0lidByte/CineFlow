...
class TvSeasonChangesById200Response(BaseModel):
    """
    TvSeasonChangesById200Response
    """  # noqa: E501

    changes: Optional[List[TvSeasonChangesById200ResponseChangesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "changes": (
                    [
                        TvSeasonChangesById200ResponseChangesInner.from_dict(_item)
