...
class TvEpisodeTranslations200Response(BaseModel):
    """
    TvEpisodeTranslations200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    translations: Optional[List[TvEpisodeTranslations200ResponseTranslationsInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "translations": (
                    [
                        TvEpisodeTranslations200ResponseTranslationsInner.from_dict(
                            _item
                        )
