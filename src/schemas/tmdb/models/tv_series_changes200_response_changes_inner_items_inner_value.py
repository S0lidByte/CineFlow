...
class TvSeriesChanges200ResponseChangesInnerItemsInnerValue(BaseModel):
    """
    TvSeriesChanges200ResponseChangesInnerItemsInnerValue
    """  # noqa: E501

    poster: Optional[TvSeriesChanges200ResponseChangesInnerItemsInnerValuePoster] = None
    __properties: ClassVar[List[str]] = ["poster"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "poster": (
                    TvSeriesChanges200ResponseChangesInnerItemsInnerValuePoster.from_dict(
                        obj["poster"]
                    )
                    if obj.get("poster") is not None
                    else None
                )
            }
        )
