...
class MovieTopRatedList200Response(BaseModel):
    """
    MovieTopRatedList200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[MovieTopRatedList200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        MovieTopRatedList200ResponseResultsInner.from_dict(_item)
