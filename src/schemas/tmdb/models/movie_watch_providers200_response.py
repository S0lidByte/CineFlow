...
class MovieWatchProviders200Response(BaseModel):
    """
    MovieWatchProviders200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[MovieWatchProviders200ResponseResults] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    MovieWatchProviders200ResponseResults.from_dict(obj["results"])
