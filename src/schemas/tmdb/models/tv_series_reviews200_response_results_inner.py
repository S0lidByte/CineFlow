...
class TvSeriesReviews200ResponseResultsInner(BaseModel):
    """
    TvSeriesReviews200ResponseResultsInner
    """  # noqa: E501

    author: Optional[StrictStr] = None
    author_details: Optional[TvSeriesReviews200ResponseResultsInnerAuthorDetails] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "author_details": (
                    TvSeriesReviews200ResponseResultsInnerAuthorDetails.from_dict(
                        obj["author_details"]
                    )
