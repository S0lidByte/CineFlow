...
class KeywordMovies200Response(BaseModel):
    """
    ...
    results: Optional[List[KeywordMovies200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        KeywordMovies200ResponseResultsInner.from_dict(_item)
