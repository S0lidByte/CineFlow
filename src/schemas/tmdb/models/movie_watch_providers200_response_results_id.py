...
class MovieWatchProviders200ResponseResultsID(BaseModel):
    """
    MovieWatchProviders200ResponseResultsID
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsIDFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsIDFlatrateInner.from_dict(
                            _item
                        )
