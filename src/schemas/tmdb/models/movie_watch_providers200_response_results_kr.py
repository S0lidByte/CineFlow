...
class MovieWatchProviders200ResponseResultsKR(BaseModel):
    """
    ...
    buy: Optional[List[MovieWatchProviders200ResponseResultsKRBuyInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "buy": (
                    [
                        MovieWatchProviders200ResponseResultsKRBuyInner.from_dict(_item)
