...
class GuestSessionRatedTv200Response(BaseModel):
    """
    GuestSessionRatedTv200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[GuestSessionRatedTv200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        GuestSessionRatedTv200ResponseResultsInner.from_dict(_item)
