...
class TvEpisodeTranslations200ResponseTranslationsInner(BaseModel):
    """
    ...
    data: Optional[TvEpisodeTranslations200ResponseTranslationsInnerData] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    TvEpisodeTranslations200ResponseTranslationsInnerData.from_dict(
                        obj["data"]
                    )
