...
class TvSeasonAccountStates200Response(BaseModel):
    """
    TvSeasonAccountStates200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[List[TvSeasonAccountStates200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeasonAccountStates200ResponseResultsInner.from_dict(_item)
