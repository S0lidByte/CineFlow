...
class DiscoverMovie200Response(BaseModel):
    """
    DiscoverMovie200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[DiscoverMovie200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        DiscoverMovie200ResponseResultsInner.from_dict(_item)
