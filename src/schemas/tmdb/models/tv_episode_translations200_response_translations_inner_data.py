...
class TvEpisodeTranslations200ResponseTranslationsInnerData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "overview"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"name": obj.get("name"), "overview": obj.get("overview")}
        )
        return _obj
