...
class TvSeriesWatchProviders200Response(BaseModel):
    """
    TvSeriesWatchProviders200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    results: Optional[TvSeriesWatchProviders200ResponseResults] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    TvSeriesWatchProviders200ResponseResults.from_dict(obj["results"])
