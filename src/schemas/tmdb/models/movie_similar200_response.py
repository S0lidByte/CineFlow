...
class MovieSimilar200Response(BaseModel):
    """
    MovieSimilar200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[MovieSimilar200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        MovieSimilar200ResponseResultsInner.from_dict(_item)
