...
class MovieChanges200ResponseChangesInnerItemsInner(BaseModel):
    """
    ...
    value: Optional[MovieChanges200ResponseChangesInnerItemsInnerValue] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "value": (
                    MovieChanges200ResponseChangesInnerItemsInnerValue.from_dict(
                        obj["value"]
                    )
