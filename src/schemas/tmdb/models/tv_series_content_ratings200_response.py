...
class TvSeriesContentRatings200Response(BaseModel):
    """
    TvSeriesContentRatings200Response
    """  # noqa: E501

    results: Optional[List[TvSeriesContentRatings200ResponseResultsInner]] = None
    id: Optional[StrictInt] = 0
    __properties: ClassVar[List[str]] = ["results", "id"]
        ...
        _obj = cls.model_validate(
            {
                "results": (
                    [
                        TvSeriesContentRatings200ResponseResultsInner.from_dict(_item)
