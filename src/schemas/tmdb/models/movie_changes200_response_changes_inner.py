...
class MovieChanges200ResponseChangesInner(BaseModel):
    """
    MovieChanges200ResponseChangesInner
    """  # noqa: E501

    key: Optional[StrictStr] = None
    items: Optional[List[MovieChanges200ResponseChangesInnerItemsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        MovieChanges200ResponseChangesInnerItemsInner.from_dict(_item)
