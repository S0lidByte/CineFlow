...
class TvSeasonAggregateCredits200ResponseCrewInner(BaseModel):
    """
    ...
    jobs: Optional[List[TvSeasonAggregateCredits200ResponseCrewInnerJobsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "jobs": (
                    [
                        TvSeasonAggregateCredits200ResponseCrewInnerJobsInner.from_dict(
                            _item
                        )
