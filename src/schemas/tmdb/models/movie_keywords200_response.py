...
class MovieKeywords200Response(BaseModel):
    """
    MovieKeywords200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    keywords: Optional[List[MovieKeywords200ResponseKeywordsInner]] = None
    __properties: ClassVar[List[str]] = ["id", "keywords"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "keywords": (
                    [
                        MovieKeywords200ResponseKeywordsInner.from_dict(_item)
                        for _item in obj["keywords"]
                    ]
