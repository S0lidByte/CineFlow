...
class MovieChanges200ResponseChangesInnerItemsInnerValue(BaseModel):
    """
    MovieChanges200ResponseChangesInnerItemsInnerValue
    """  # noqa: E501

    poster: Optional[MovieChanges200ResponseChangesInnerItemsInnerValuePoster] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "poster": (
                    MovieChanges200ResponseChangesInnerItemsInnerValuePoster.from_dict(
                        obj["poster"]
                    )
