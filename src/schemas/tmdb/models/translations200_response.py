...
class Translations200Response(BaseModel):
    """
    Translations200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    translations: Optional[List[Translations200ResponseTranslationsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "translations": (
                    [
                        Translations200ResponseTranslationsInner.from_dict(_item)
