...
class ListCheckItemStatus200Response(BaseModel):
    """
    ListCheckItemStatus200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    item_present: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["id", "item_present"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "item_present": (
                    obj.get("item_present")
                    if obj.get("item_present") is not None
                    else True
                ),
            }
        )
