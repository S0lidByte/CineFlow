...
class GuestSessionRatedTvEpisodes200Response(BaseModel):
    """
    GuestSessionRatedTvEpisodes200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[GuestSessionRatedTvEpisodes200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        GuestSessionRatedTvEpisodes200ResponseResultsInner.from_dict(
                            _item
                        )
