...
class AccountWatchlistMovies200Response(BaseModel):
    """
    AccountWatchlistMovies200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[AccountWatchlistMovies200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        AccountWatchlistMovies200ResponseResultsInner.from_dict(_item)
