...
class AccountRatedMovies200Response(BaseModel):
    """
    AccountRatedMovies200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[AccountRatedMovies200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        AccountRatedMovies200ResponseResultsInner.from_dict(_item)
