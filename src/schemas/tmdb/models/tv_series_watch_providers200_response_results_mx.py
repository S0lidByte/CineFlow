...
class TvSeriesWatchProviders200ResponseResultsMX(BaseModel):
    """
    TvSeriesWatchProviders200ResponseResultsMX
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsTTFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsTTFlatrateInner.from_dict(
                            _item
                        )
