...
class MovieTranslations200Response(BaseModel):
    """
    MovieTranslations200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    translations: Optional[List[MovieTranslations200ResponseTranslationsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "translations": (
                    [
                        MovieTranslations200ResponseTranslationsInner.from_dict(_item)
