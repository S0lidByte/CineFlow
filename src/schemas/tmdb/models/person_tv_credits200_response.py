...
class PersonTvCredits200Response(BaseModel):
    """
    PersonTvCredits200Response
    """  # noqa: E501

    cast: Optional[List[PersonTvCredits200ResponseCastInner]] = None
    crew: Optional[List[PersonTvCredits200ResponseCrewInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "cast": (
                    [
                        PersonTvCredits200ResponseCastInner.from_dict(_item)
                ...
                "crew": (
                    [
                        PersonTvCredits200ResponseCrewInner.from_dict(_item)
