...
class MovieCredits200Response(BaseModel):
    """
    MovieCredits200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    cast: Optional[List[MovieCredits200ResponseCastInner]] = None
    crew: Optional[List[MovieCredits200ResponseCrewInner]] = None
    __properties: ClassVar[List[str]] = ["id", "cast", "crew"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "cast": (
                    [
                        MovieCredits200ResponseCastInner.from_dict(_item)
                ...
                "crew": (
                    [
                        MovieCredits200ResponseCrewInner.from_dict(_item)
