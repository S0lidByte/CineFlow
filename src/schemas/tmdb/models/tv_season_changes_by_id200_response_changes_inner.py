...
class TvSeasonChangesById200ResponseChangesInner(BaseModel):
    """
    TvSeasonChangesById200ResponseChangesInner
    """  # noqa: E501

    key: Optional[StrictStr] = None
    items: Optional[List[TvSeasonChangesById200ResponseChangesInnerItemsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        TvSeasonChangesById200ResponseChangesInnerItemsInner.from_dict(
                            _item
                        )
