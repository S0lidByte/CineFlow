...
class PersonChanges200ResponseChangesInner(BaseModel):
    """
    PersonChanges200ResponseChangesInner
    """  # noqa: E501

    key: Optional[StrictStr] = None
    items: Optional[List[PersonChanges200ResponseChangesInnerItemsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        PersonChanges200ResponseChangesInnerItemsInner.from_dict(_item)
