...
class TvSeriesSimilar200Response(BaseModel):
    """
    TvSeriesSimilar200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[TvSeriesSimilar200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeriesSimilar200ResponseResultsInner.from_dict(_item)
