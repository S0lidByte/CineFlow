...
class MovieReviews200Response(BaseModel):
    """
    ...
    results: Optional[List[MovieReviews200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        MovieReviews200ResponseResultsInner.from_dict(_item)
