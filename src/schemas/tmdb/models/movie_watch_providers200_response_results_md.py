...
class MovieWatchProviders200ResponseResultsMD(BaseModel):
    """
    ...
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsMDFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsMDFlatrateInner.from_dict(
                            _item
                        )
