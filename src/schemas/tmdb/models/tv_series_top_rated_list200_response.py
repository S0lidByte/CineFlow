...
class TvSeriesTopRatedList200Response(BaseModel):
    """
    TvSeriesTopRatedList200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[TvSeriesTopRatedList200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        TvSeriesTopRatedList200ResponseResultsInner.from_dict(_item)
