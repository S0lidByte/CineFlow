...
class TvSeriesEpisodeGroups200Response(BaseModel):
    """
    TvSeriesEpisodeGroups200Response
    """  # noqa: E501

    results: Optional[List[TvSeriesEpisodeGroups200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "results": (
                    [
                        TvSeriesEpisodeGroups200ResponseResultsInner.from_dict(_item)
