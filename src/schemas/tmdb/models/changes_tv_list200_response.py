...
class ChangesTvList200Response(BaseModel):
    """
    ChangesTvList200Response
    """  # noqa: E501

    results: Optional[List[ChangesTvList200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "results": (
                    [
                        ChangesTvList200ResponseResultsInner.from_dict(_item)
