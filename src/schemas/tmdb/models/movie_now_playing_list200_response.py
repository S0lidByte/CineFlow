...
class MovieNowPlayingList200Response(BaseModel):
    """
    MovieNowPlayingList200Response
    """  # noqa: E501

    dates: Optional[MovieNowPlayingList200ResponseDates] = None
    page: Optional[StrictInt] = 0
    results: Optional[List[MovieNowPlayingList200ResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "dates": (
                    MovieNowPlayingList200ResponseDates.from_dict(obj["dates"])
                ...
                "results": (
                    [
                        MovieNowPlayingList200ResponseResultsInner.from_dict(_item)
                ...
                "total_pages": (
                    obj.get("total_pages") if obj.get("total_pages") is not None else 0
                ),
                "total_results": (
                    obj.get("total_results")
                    if obj.get("total_results") is not None
                    else 0
                ),
            }
        )
