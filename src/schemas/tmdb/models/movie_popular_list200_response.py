...
class MoviePopularList200Response(BaseModel):
    """
    MoviePopularList200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[MoviePopularList200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        MoviePopularList200ResponseResultsInner.from_dict(_item)
