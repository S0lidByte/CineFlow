...
class TvSeriesWatchProviders200ResponseResultsNZ(BaseModel):
    """
    ...
    flatrate: Optional[
        List[TvSeriesWatchProviders200ResponseResultsNZFlatrateInner]
    ] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        TvSeriesWatchProviders200ResponseResultsNZFlatrateInner.from_dict(
                            _item
                        )
