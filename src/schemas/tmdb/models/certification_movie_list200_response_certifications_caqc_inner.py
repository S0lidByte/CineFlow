...
class CertificationMovieList200ResponseCertificationsCAQCInner(BaseModel):
    """
    CertificationMovieList200ResponseCertificationsCAQCInner
    """  # noqa: E501

    certification: Optional[StrictStr] = None
    meaning: Optional[StrictStr] = None
    order: Optional[StrictInt] = 0
    __properties: ClassVar[List[str]] = ["certification", "meaning", "order"]
