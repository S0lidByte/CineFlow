...
class TvEpisodeGroupDetails200ResponseGroupsInner(BaseModel):
    """
    ...
    episodes: Optional[
        List[TvEpisodeGroupDetails200ResponseGroupsInnerEpisodesInner]
    ] = None
    locked: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["id", "name", "order", "episodes", "locked"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "episodes": (
                    [
                        TvEpisodeGroupDetails200ResponseGroupsInnerEpisodesInner.from_dict(
                            _item
                        )
                ...
                "locked": obj.get("locked") if obj.get("locked") is not None else True,
            }
        )
        return _obj
