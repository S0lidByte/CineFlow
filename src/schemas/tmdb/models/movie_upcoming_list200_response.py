...
class MovieUpcomingList200Response(BaseModel):
    """
    MovieUpcomingList200Response
    """  # noqa: E501

    dates: Optional[MovieUpcomingList200ResponseDates] = None
    page: Optional[StrictInt] = 0
    results: Optional[List[MovieUpcomingList200ResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "dates": (
                    MovieUpcomingList200ResponseDates.from_dict(obj["dates"])
                ...
                "results": (
                    [
                        MovieUpcomingList200ResponseResultsInner.from_dict(_item)
