...
class SearchCollection200Response(BaseModel):
    """
    SearchCollection200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[SearchCollection200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        SearchCollection200ResponseResultsInner.from_dict(_item)
