...
class ChangesPeopleList200Response(BaseModel):
    """
    ChangesPeopleList200Response
    """  # noqa: E501

    results: Optional[List[ChangesPeopleList200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "results": (
                    [
                        ChangesPeopleList200ResponseResultsInner.from_dict(_item)
