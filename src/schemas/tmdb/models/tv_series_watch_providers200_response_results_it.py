...
class TvSeriesWatchProviders200ResponseResultsIT(BaseModel):
    """
    TvSeriesWatchProviders200ResponseResultsIT
    """  # noqa: E501

    link: Optional[StrictStr] = None
    buy: Optional[List[TvSeriesWatchProviders200ResponseResultsITBuyInner]] = None
    flatrate: Optional[
        List[TvSeriesWatchProviders200ResponseResultsIEFlatrateInner]
    ] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "buy": (
                    [
                        TvSeriesWatchProviders200ResponseResultsITBuyInner.from_dict(
                            _item
                        )
                ...
                "flatrate": (
                    [
                        TvSeriesWatchProviders200ResponseResultsIEFlatrateInner.from_dict(
                            _item
                        )
