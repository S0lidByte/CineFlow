...
class PersonPopularList200Response(BaseModel):
    """
    PersonPopularList200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[PersonPopularList200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        PersonPopularList200ResponseResultsInner.from_dict(_item)
