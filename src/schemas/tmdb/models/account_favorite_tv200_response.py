...
class AccountFavoriteTv200Response(BaseModel):
    """
    AccountFavoriteTv200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[AccountFavoriteTv200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        AccountFavoriteTv200ResponseResultsInner.from_dict(_item)
