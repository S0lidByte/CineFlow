...
class MovieChanges200Response(BaseModel):
    """
    MovieChanges200Response
    """  # noqa: E501

    changes: Optional[List[MovieChanges200ResponseChangesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "changes": (
                    [
                        MovieChanges200ResponseChangesInner.from_dict(_item)
