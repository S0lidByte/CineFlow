...
class TvSeasonTranslations200ResponseTranslationsInner(BaseModel):
    """
    ...
    data: Optional[TvSeasonTranslations200ResponseTranslationsInnerData] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    TvSeasonTranslations200ResponseTranslationsInnerData.from_dict(
                        obj["data"]
                    )
