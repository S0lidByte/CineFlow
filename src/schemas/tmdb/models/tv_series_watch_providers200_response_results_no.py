...
class TvSeriesWatchProviders200ResponseResultsNO(BaseModel):
    """
    ...
    flatrate: Optional[
        List[TvSeriesWatchProviders200ResponseResultsARFlatrateInner]
    ] = None
    buy: Optional[List[TvSeriesWatchProviders200ResponseResultsNOBuyInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        TvSeriesWatchProviders200ResponseResultsARFlatrateInner.from_dict(
                            _item
                        )
                ...
                "buy": (
                    [
                        TvSeriesWatchProviders200ResponseResultsNOBuyInner.from_dict(
                            _item
                        )
