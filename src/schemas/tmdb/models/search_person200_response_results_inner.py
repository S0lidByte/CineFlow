...
class SearchPerson200ResponseResultsInner(BaseModel):
    """
    ...
    known_for: Optional[List[SearchPerson200ResponseResultsInnerKnownForInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "known_for": (
                    [
                        SearchPerson200ResponseResultsInnerKnownForInner.from_dict(
                            _item
                        )
