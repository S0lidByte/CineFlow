...
class MovieWatchProviders200ResponseResultsMK(BaseModel):
    """
    MovieWatchProviders200ResponseResultsMK
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsMKFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsMKFlatrateInner.from_dict(
                            _item
                        )
