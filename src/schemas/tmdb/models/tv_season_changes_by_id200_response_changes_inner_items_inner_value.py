...
class TvSeasonChangesById200ResponseChangesInnerItemsInnerValue(BaseModel):
    """
    TvSeasonChangesById200ResponseChangesInnerItemsInnerValue
    """  # noqa: E501

    episode_id: Optional[StrictInt] = 0
    episode_number: Optional[StrictInt] = 0
    __properties: ClassVar[List[str]] = ["episode_id", "episode_number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "episode_id": (
                    obj.get("episode_id") if obj.get("episode_id") is not None else 0
                ),
                "episode_number": (
