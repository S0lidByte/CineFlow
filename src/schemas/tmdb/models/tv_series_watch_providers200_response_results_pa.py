...
class TvSeriesWatchProviders200ResponseResultsPA(BaseModel):
    """
    TvSeriesWatchProviders200ResponseResultsPA
    """  # noqa: E501

    link: Optional[StrictStr] = None
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsJMFlatrateInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "flatrate": (
                    [
                        MovieWatchProviders200ResponseResultsJMFlatrateInner.from_dict(
                            _item
                        )
