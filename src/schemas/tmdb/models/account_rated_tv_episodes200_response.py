...
class AccountRatedTvEpisodes200Response(BaseModel):
    """
    AccountRatedTvEpisodes200Response
    """  # noqa: E501

    page: Optional[StrictInt] = 0
    results: Optional[List[AccountRatedTvEpisodes200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        AccountRatedTvEpisodes200ResponseResultsInner.from_dict(_item)
