...
class TvSeasonTranslations200Response(BaseModel):
    """
    TvSeasonTranslations200Response
    """  # noqa: E501

    id: Optional[StrictInt] = 0
    translations: Optional[List[TvSeasonTranslations200ResponseTranslationsInner]] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "translations": (
                    [
                        TvSeasonTranslations200ResponseTranslationsInner.from_dict(
                            _item
                        )
