...
class ConfigurationTimezones200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["iso_3166_1", "zones"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"iso_3166_1": obj.get("iso_3166_1"), "zones": obj.get("zones")}
        )
        return _obj
