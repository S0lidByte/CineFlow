...
class PersonTaggedImages200Response(BaseModel):
    """
    ...
    results: Optional[List[PersonTaggedImages200ResponseResultsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        PersonTaggedImages200ResponseResultsInner.from_dict(_item)
