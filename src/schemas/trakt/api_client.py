...
import schemas.trakt.models
from schemas.trakt import rest
from schemas.trakt.api_response import ApiResponse
from schemas.trakt.api_response import T as ApiResponseT
from schemas.trakt.configuration import Configuration
from schemas.trakt.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(schemas.trakt.models, klass)
