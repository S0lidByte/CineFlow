...
class GetItemsOnAPersonalList200ResponseInner(BaseModel):
    """
    ...
    season: Optional[GetItemsOnAList200ResponseInnerSeason] = None
    episode: Optional[GetItemsOnAList200ResponseInnerEpisode] = None
    person: Optional[GetItemsOnAList200ResponseInnerPerson] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetItemsOnAPersonalList200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetItemsOnAPersonalList200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "season": (
                    GetItemsOnAList200ResponseInnerSeason.from_dict(obj["season"])
                    if obj.get("season") is not None
                    else None
                ),
                "episode": (
                    GetItemsOnAList200ResponseInnerEpisode.from_dict(obj["episode"])
                    if obj.get("episode") is not None
                    else None
                ),
                "person": (
                    GetItemsOnAList200ResponseInnerPerson.from_dict(obj["person"])
