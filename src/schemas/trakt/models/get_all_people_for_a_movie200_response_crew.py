...
class GetAllPeopleForAMovie200ResponseCrew(BaseModel):
    """
    GetAllPeopleForAMovie200ResponseCrew
    """  # noqa: E501

    production: Optional[List[GetAllPeopleForAMovie200ResponseCrewProductionInner]] = (
        None
    )
    art: Optional[List[GetAllPeopleForAMovie200ResponseCrewArtInner]] = None
    crew: Optional[List[GetAllPeopleForAMovie200ResponseCrewArtInner]] = None
    costume__make_up: Optional[List[GetAllPeopleForAMovie200ResponseCrewArtInner]] = (
        Field(default=None, alias="costume & make-up")
    )
    directing: Optional[List[GetAllPeopleForAMovie200ResponseCrewDirectingInner]] = None
    writing: Optional[List[GetAllPeopleForAMovie200ResponseCrewProductionInner]] = None
    sound: Optional[List[GetAllPeopleForAMovie200ResponseCrewDirectingInner]] = None
    camera: Optional[List[GetAllPeopleForAMovie200ResponseCrewDirectingInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAMovie200ResponseCrew from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in production (list)
        _items = []
        if self.production:
            for _item_production in self.production:
                if _item_production:
                    _items.append(_item_production.to_dict())
            _dict["production"] = _items
        ...
        if self.crew:
            ...
            _dict["crew"] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in costume__make_up (list)
        _items = []
        if self.costume__make_up:
            for _item_costume__make_up in self.costume__make_up:
                if _item_costume__make_up:
                    _items.append(_item_costume__make_up.to_dict())
            _dict["costume & make-up"] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in directing (list)
        _items = []
        if self.directing:
            for _item_directing in self.directing:
                if _item_directing:
                    _items.append(_item_directing.to_dict())
            _dict["directing"] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in writing (list)
        _items = []
        if self.writing:
            for _item_writing in self.writing:
                if _item_writing:
                    _items.append(_item_writing.to_dict())
            _dict["writing"] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in sound (list)
        _items = []
        if self.sound:
            for _item_sound in self.sound:
                if _item_sound:
                    _items.append(_item_sound.to_dict())
            _dict["sound"] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in camera (list)
        _items = []
        if self.camera:
            for _item_camera in self.camera:
                if _item_camera:
                    _items.append(_item_camera.to_dict())
            _dict["camera"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAMovie200ResponseCrew from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "production": (
                    [
                        GetAllPeopleForAMovie200ResponseCrewProductionInner.from_dict(
                            _item
                        )
                        for _item in obj["production"]
                    ]
                    if obj.get("production") is not None
                    else None
                ),
                "art": (
                    [
                        GetAllPeopleForAMovie200ResponseCrewArtInner.from_dict(_item)
                        for _item in obj["art"]
                    ]
                ...
                "costume & make-up": (
                    [
                        GetAllPeopleForAMovie200ResponseCrewArtInner.from_dict(_item)
                        for _item in obj["costume & make-up"]
                    ]
                    if obj.get("costume & make-up") is not None
                    else None
                ),
                "directing": (
                    [
                        GetAllPeopleForAMovie200ResponseCrewDirectingInner.from_dict(
                            _item
                        )
                        for _item in obj["directing"]
                    ]
                    if obj.get("directing") is not None
                    else None
                ),
                "writing": (
                    [
                        ...
                        for _item in obj["writing"]
                    ]
                    if obj.get("writing") is not None
                    else None
                ),
                "sound": (
                    [
                        ...
                        for _item in obj["sound"]
                    ]
                    if obj.get("sound") is not None
                    else None
                ),
                "camera": (
                    [
                        ...
                        for _item in obj["camera"]
                    ]
                    if obj.get("camera") is not None
                    else None
                ),
            }
        )
