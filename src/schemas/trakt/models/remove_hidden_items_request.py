...
class RemoveHiddenItemsRequest(BaseModel):
    """
    RemoveHiddenItemsRequest
    """  # noqa: E501

    movies: Optional[List[RemoveItemsFromCollectionRequestMoviesInner]] = None
    shows: Optional[List[RemoveHiddenItemsRequestShowsInner]] = None
    seasons: Optional[List[AddHiddenItemsRequestSeasonsInner]] = None
    __properties: ClassVar[List[str]] = ["movies", "shows", "seasons"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RemoveHiddenItemsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RemoveHiddenItemsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "shows": (
                    [
                        RemoveHiddenItemsRequestShowsInner.from_dict(_item)
                ...
                "seasons": (
                    [
                        AddHiddenItemsRequestSeasonsInner.from_dict(_item)
