...
class AddItemsToCollectionRequest(BaseModel):
    """
    AddItemsToCollectionRequest
    """  # noqa: E501

    movies: Optional[List[AddItemsToCollectionRequestMoviesInner]] = None
    shows: Optional[List[AddItemsToCollectionRequestShowsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "movies": (
                    [
                        AddItemsToCollectionRequestMoviesInner.from_dict(_item)
                ...
                "shows": (
                    [
                        AddItemsToCollectionRequestShowsInner.from_dict(_item)
