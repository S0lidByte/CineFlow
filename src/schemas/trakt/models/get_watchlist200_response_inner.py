...
class GetWatchlist200ResponseInner(BaseModel):
    """
    ...
    notes: Optional[Any]
    type: StrictStr
    episode: GetShows200ResponseInnerEpisode
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWatchlist200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWatchlist200ResponseInner from a dict"""
        if obj is None:
            return None
