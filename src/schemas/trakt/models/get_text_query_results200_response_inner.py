...
class GetTextQueryResults200ResponseInner(BaseModel):
    """
    ...
    list: Optional[GetTrendingLists200ResponseInnerList] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTextQueryResults200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTextQueryResults200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "list": (
                    GetTrendingLists200ResponseInnerList.from_dict(obj["list"])
