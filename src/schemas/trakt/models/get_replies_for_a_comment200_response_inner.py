...
class GetRepliesForAComment200ResponseInner(BaseModel):
    """
    ...
    user_stats: Optional[GetACommentOrReply200ResponseUserStats] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRepliesForAComment200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRepliesForAComment200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "likes": obj.get("likes"),
                "user_stats": (
                    GetACommentOrReply200ResponseUserStats.from_dict(obj["user_stats"])
