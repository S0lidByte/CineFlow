...
class AddItemsToPersonalListRequest(BaseModel):
    """
    AddItemsToPersonalListRequest
    """  # noqa: E501

    movies: Optional[List[AddItemsToPersonalListRequestMoviesInner]] = None
    shows: Optional[List[AddItemsToPersonalListRequestShowsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "movies": (
                    [
                        AddItemsToPersonalListRequestMoviesInner.from_dict(_item)
                ...
                "shows": (
                    [
                        AddItemsToPersonalListRequestShowsInner.from_dict(_item)
