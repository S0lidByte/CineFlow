...
class GetStats200Response(BaseModel):
    """
    GetStats200Response
    """  # noqa: E501

    movies: Optional[GetStats200ResponseMovies] = None
    shows: Optional[GetStats200ResponseShows] = None
    seasons: Optional[GetStats200ResponseSeasons] = None
    episodes: Optional[GetStats200ResponseMovies] = None
    network: Optional[GetStats200ResponseNetwork] = None
    ratings: Optional[GetStats200ResponseRatings] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "movies": (
                    GetStats200ResponseMovies.from_dict(obj["movies"])
                    if obj.get("movies") is not None
                    else None
                ),
                "shows": (
                    GetStats200ResponseShows.from_dict(obj["shows"])
                    if obj.get("shows") is not None
                    else None
                ),
                "seasons": (
                    GetStats200ResponseSeasons.from_dict(obj["seasons"])
                    if obj.get("seasons") is not None
                    else None
                ),
                "episodes": (
                    GetStats200ResponseMovies.from_dict(obj["episodes"])
                    if obj.get("episodes") is not None
                    else None
                ),
                "network": (
                    GetStats200ResponseNetwork.from_dict(obj["network"])
                    if obj.get("network") is not None
                    else None
                ),
                "ratings": (
                    GetStats200ResponseRatings.from_dict(obj["ratings"])
