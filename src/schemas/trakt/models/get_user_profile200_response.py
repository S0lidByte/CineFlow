...
class GetUserProfile200Response(BaseModel):
    ...
    ids: Optional[PostAComment201ResponseUserIds] = None
    vip_og: Optional[StrictBool] = None
    vip_years: Optional[Union[StrictFloat, StrictInt]] = None
    vip_cover_image: Optional[StrictStr] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "ids": (
                    PostAComment201ResponseUserIds.from_dict(obj["ids"])
                    if obj.get("ids") is not None
                    else None
                ),
                "vip_og": obj.get("vip_og"),
                "vip_years": obj.get("vip_years"),
                "vip_cover_image": obj.get("vip_cover_image"),
            }
        )
        return _obj
