...
class GetLastActivity200Response(BaseModel):
    ...
    movies: Optional[GetLastActivity200ResponseMovies] = None
    episodes: Optional[GetLastActivity200ResponseEpisodes] = None
    shows: Optional[GetLastActivity200ResponseShows] = None
    seasons: Optional[GetLastActivity200ResponseSeasons] = None
    comments: Optional[GetLastActivity200ResponseComments] = None
    lists: Optional[GetLastActivity200ResponseLists] = None
    watchlist: Optional[GetLastActivity200ResponseWatchlist] = None
    favorites: Optional[GetLastActivity200ResponseWatchlist] = None
    account: Optional[GetLastActivity200ResponseAccount] = None
    saved_filters: Optional[GetLastActivity200ResponseWatchlist] = None
    notes: Optional[GetLastActivity200ResponseWatchlist] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLastActivity200Response from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of movies
        if self.movies:
            _dict["movies"] = self.movies.to_dict()
        # override the default output from pydantic by calling `to_dict()` of episodes
        if self.episodes:
            _dict["episodes"] = self.episodes.to_dict()
        # override the default output from pydantic by calling `to_dict()` of shows
        if self.shows:
            _dict["shows"] = self.shows.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of saved_filters
        if self.saved_filters:
            _dict["saved_filters"] = self.saved_filters.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLastActivity200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "all": obj.get("all"),
                "movies": (
                    GetLastActivity200ResponseMovies.from_dict(obj["movies"])
                    if obj.get("movies") is not None
                    else None
                ),
                "episodes": (
                    GetLastActivity200ResponseEpisodes.from_dict(obj["episodes"])
                    if obj.get("episodes") is not None
                    else None
                ),
                "shows": (
                    GetLastActivity200ResponseShows.from_dict(obj["shows"])
                    if obj.get("shows") is not None
                    else None
                ),
                "seasons": (
                    GetLastActivity200ResponseSeasons.from_dict(obj["seasons"])
                    if obj.get("seasons") is not None
                    else None
                ),
                "comments": (
                    GetLastActivity200ResponseComments.from_dict(obj["comments"])
                    if obj.get("comments") is not None
                    else None
                ),
                "lists": (
                    GetLastActivity200ResponseLists.from_dict(obj["lists"])
                    if obj.get("lists") is not None
                    else None
                ),
                "watchlist": (
                    GetLastActivity200ResponseWatchlist.from_dict(obj["watchlist"])
                    if obj.get("watchlist") is not None
                    else None
                ),
                "favorites": (
                    GetLastActivity200ResponseWatchlist.from_dict(obj["favorites"])
                    if obj.get("favorites") is not None
                    else None
                ),
                "account": (
                    GetLastActivity200ResponseAccount.from_dict(obj["account"])
                    if obj.get("account") is not None
                    else None
                ),
                "saved_filters": (
                    GetLastActivity200ResponseWatchlist.from_dict(obj["saved_filters"])
                    if obj.get("saved_filters") is not None
                    else None
                ),
                "notes": (
                    GetLastActivity200ResponseWatchlist.from_dict(obj["notes"])
