...
class GetAllPeopleForAShow200Response(BaseModel):
    """
    ...
    crew: Optional[GetAllPeopleForAShow200ResponseCrew] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAShow200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAShow200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "crew": (
                    GetAllPeopleForAShow200ResponseCrew.from_dict(obj["crew"])
