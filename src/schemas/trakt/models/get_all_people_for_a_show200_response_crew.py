...
class GetAllPeopleForAShow200ResponseCrew(BaseModel):
    """
    GetAllPeopleForAShow200ResponseCrew
    """  # noqa: E501

    art: Optional[List[GetAllPeopleForAShow200ResponseCrewArtInner]] = None
    production: Optional[List[GetAllPeopleForAShow200ResponseCrewArtInner]] = None
    sound: Optional[List[GetAllPeopleForAShow200ResponseCrewArtInner]] = None
    visual_effects: Optional[
        List[GetAllPeopleForAShow200ResponseCrewVisualEffectsInner]
    ] = Field(default=None, alias="visual effects")
    costume__make_up: Optional[
        List[GetAllPeopleForAShow200ResponseCrewVisualEffectsInner]
    ] = Field(default=None, alias="costume & make-up")
    writing: Optional[List[GetAllPeopleForAShow200ResponseCrewVisualEffectsInner]] = (
        None
    )
    directing: Optional[List[GetAllPeopleForAShow200ResponseCrewArtInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAShow200ResponseCrew from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.sound:
            ...
            _dict["sound"] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in visual_effects (list)
        _items = []
        if self.visual_effects:
            for _item_visual_effects in self.visual_effects:
                if _item_visual_effects:
                    _items.append(_item_visual_effects.to_dict())
            _dict["visual effects"] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAShow200ResponseCrew from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "art": (
                    [
                        GetAllPeopleForAShow200ResponseCrewArtInner.from_dict(_item)
                ...
                "visual effects": (
                    [
                        GetAllPeopleForAShow200ResponseCrewVisualEffectsInner.from_dict(
                            _item
                        )
                        for _item in obj["visual effects"]
                    ]
                    if obj.get("visual effects") is not None
                    else None
                ),
                "costume & make-up": (
                    [
