...
class StartWatchingInAMediaCenter201Response(BaseModel):
    """
    ...
    sharing: Optional[CheckIntoAnItemRequestSharing] = None
    episode: Optional[CheckIntoAnItem201ResponseEpisode] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartWatchingInAMediaCenter201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartWatchingInAMediaCenter201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "sharing": (
                    CheckIntoAnItemRequestSharing.from_dict(obj["sharing"])
                    if obj.get("sharing") is not None
                    else None
                ),
                "episode": (
                    CheckIntoAnItem201ResponseEpisode.from_dict(obj["episode"])
