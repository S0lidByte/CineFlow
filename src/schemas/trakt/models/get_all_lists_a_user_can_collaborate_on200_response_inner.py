...
class GetAllListsAUserCanCollaborateOn200ResponseInner(BaseModel):
    """
    ...
    display_numbers: Optional[StrictBool] = None
    allow_comments: Optional[StrictBool] = None
    sort_by: Optional[StrictStr] = None
    sort_how: Optional[StrictStr] = None
    created_at: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    item_count: Optional[Union[StrictFloat, StrictInt]] = None
    comment_count: Optional[Union[StrictFloat, StrictInt]] = None
    likes: Optional[Union[StrictFloat, StrictInt]] = None
    ids: Optional[GetTrendingComments200ResponseInnerListIds] = None
    user: Optional[GetNotes200ResponseInnerNoteUser] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllListsAUserCanCollaborateOn200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllListsAUserCanCollaborateOn200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "type": obj.get("type"),
                "display_numbers": obj.get("display_numbers"),
                "allow_comments": obj.get("allow_comments"),
                "sort_by": obj.get("sort_by"),
                "sort_how": obj.get("sort_how"),
                ...
                "likes": obj.get("likes"),
                "ids": (
                    GetTrendingComments200ResponseInnerListIds.from_dict(obj["ids"])
                    if obj.get("ids") is not None
                    else None
                ),
                "user": (
                    GetNotes200ResponseInnerNoteUser.from_dict(obj["user"])
