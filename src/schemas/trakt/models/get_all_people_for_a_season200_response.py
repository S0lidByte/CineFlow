...
class GetAllPeopleForASeason200Response(BaseModel):
    """
    GetAllPeopleForASeason200Response
    """  # noqa: E501

    cast: Optional[List[GetAllPeopleForAShow200ResponseCastInner]] = None
    guest_stars: Optional[List[GetAllPeopleForAShow200ResponseCastInner]] = None
    crew: Optional[GetAllPeopleForASeason200ResponseCrew] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllPeopleForASeason200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllPeopleForASeason200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "cast": (
                    [
                        GetAllPeopleForAShow200ResponseCastInner.from_dict(_item)
                ...
                "crew": (
                    GetAllPeopleForASeason200ResponseCrew.from_dict(obj["crew"])
