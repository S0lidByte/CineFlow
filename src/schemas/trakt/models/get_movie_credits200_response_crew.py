...
class GetMovieCredits200ResponseCrew(BaseModel):
    """
    GetMovieCredits200ResponseCrew
    """  # noqa: E501

    directing: Optional[List[GetMovieCredits200ResponseCrewDirectingInner]] = None
    writing: Optional[List[GetMovieCredits200ResponseCrewDirectingInner]] = None
    producing: Optional[List[GetMovieCredits200ResponseCrewDirectingInner]] = None
    __properties: ClassVar[List[str]] = ["directing", "writing", "producing"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetMovieCredits200ResponseCrew from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in producing (list)
        _items = []
        if self.producing:
            for _item_producing in self.producing:
                if _item_producing:
                    _items.append(_item_producing.to_dict())
            _dict["producing"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetMovieCredits200ResponseCrew from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "directing": (
                    [
                        GetMovieCredits200ResponseCrewDirectingInner.from_dict(_item)
                ...
                "producing": (
                    [
                        GetMovieCredits200ResponseCrewDirectingInner.from_dict(_item)
                        for _item in obj["producing"]
                    ]
                    if obj.get("producing") is not None
                    else None
                ),
            }
        )
