...
class RemoveItemsFromPersonalListRequest(BaseModel):
    """
    RemoveItemsFromPersonalListRequest
    """  # noqa: E501

    movies: Optional[List[RemoveItemsFromPersonalListRequestMoviesInner]] = None
    shows: Optional[List[RemoveItemsFromPersonalListRequestShowsInner]] = None
    seasons: Optional[List[AddItemsToCollectionRequestSeasonsInner]] = None
    episodes: Optional[List[AddItemsToCollectionRequestEpisodesInner]] = None
    people: Optional[List[GetItemsOnAList200ResponseInnerPerson]] = None
        ...
        _obj = cls.model_validate(
            {
                "movies": (
                    [
                        RemoveItemsFromPersonalListRequestMoviesInner.from_dict(_item)
                ...
                "shows": (
                    [
                        RemoveItemsFromPersonalListRequestShowsInner.from_dict(_item)
                ...
                "seasons": (
                    [
                        AddItemsToCollectionRequestSeasonsInner.from_dict(_item)
                ...
                "episodes": (
                    [
                        AddItemsToCollectionRequestEpisodesInner.from_dict(_item)
                ...
                "people": (
                    [
                        GetItemsOnAList200ResponseInnerPerson.from_dict(_item)
