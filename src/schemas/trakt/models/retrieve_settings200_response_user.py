...
class RetrieveSettings200ResponseUser(BaseModel):
    """
    ...
    vip_ep: Optional[StrictBool] = None
    ids: Optional[RetrieveSettings200ResponseUserIds] = None
    joined_at: Optional[StrictStr] = None
    location: Optional[StrictStr] = None
    about: Optional[StrictStr] = None
    gender: Optional[StrictStr] = None
    age: Optional[Union[StrictFloat, StrictInt]] = None
    images: Optional[RetrieveSettings200ResponseUserImages] = None
    vip_og: Optional[StrictBool] = None
    vip_years: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetrieveSettings200ResponseUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetrieveSettings200ResponseUser from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name"),
                "vip": obj.get("vip"),
                "vip_ep": obj.get("vip_ep"),
                "ids": (
                    RetrieveSettings200ResponseUserIds.from_dict(obj["ids"])
                ...
                "age": obj.get("age"),
                "images": (
                    RetrieveSettings200ResponseUserImages.from_dict(obj["images"])
                    if obj.get("images") is not None
                    else None
                ),
                "vip_og": obj.get("vip_og"),
                "vip_years": obj.get("vip_years"),
            }
        )
        return _obj
