...
class GetAllPeopleForAnEpisode200ResponseCrew(BaseModel):
    """
    GetAllPeopleForAnEpisode200ResponseCrew
    """  # noqa: E501

    writing: Optional[List[GetAllPeopleForAMovie200ResponseCrewArtInner]] = None
    ...
    editing: Optional[List[GetAllPeopleForAMovie200ResponseCrewDirectingInner]] = None
    __properties: ClassVar[List[str]] = ["writing", "directing", "camera", "editing"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAnEpisode200ResponseCrew from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.camera:
            ...
            _dict["camera"] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in editing (list)
        _items = []
        if self.editing:
            for _item_editing in self.editing:
                if _item_editing:
                    _items.append(_item_editing.to_dict())
            _dict["editing"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAnEpisode200ResponseCrew from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "editing": (
                    [
                        ...
                        for _item in obj["editing"]
                    ]
                    if obj.get("editing") is not None
                    else None
                ),
            }
        )
