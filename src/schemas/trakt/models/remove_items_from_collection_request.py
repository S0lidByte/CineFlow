...
class RemoveItemsFromCollectionRequest(BaseModel):
    """
    RemoveItemsFromCollectionRequest
    """  # noqa: E501

    movies: Optional[List[RemoveItemsFromCollectionRequestMoviesInner]] = None
    shows: Optional[List[RemoveItemsFromCollectionRequestShowsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "movies": (
                    [
                        RemoveItemsFromCollectionRequestMoviesInner.from_dict(_item)
                ...
                "shows": (
                    [
                        RemoveItemsFromCollectionRequestShowsInner.from_dict(_item)
