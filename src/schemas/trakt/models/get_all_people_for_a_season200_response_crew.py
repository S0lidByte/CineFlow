...
class GetAllPeopleForASeason200ResponseCrew(BaseModel):
    """
    GetAllPeopleForASeason200ResponseCrew
    """  # noqa: E501

    production: Optional[List[GetAllPeopleForAShow200ResponseCrewArtInner]] = None
    sound: Optional[List[GetAllPeopleForAShow200ResponseCrewVisualEffectsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllPeopleForASeason200ResponseCrew from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllPeopleForASeason200ResponseCrew from a dict"""
        if obj is None:
            return None
