...
class AddItemsToWatchlist201Response(BaseModel):
    """
    AddItemsToWatchlist201Response
    """  # noqa: E501

    added: Optional[AddNewRatings201ResponseAdded] = None
    existing: Optional[AddNewRatings201ResponseAdded] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddItemsToWatchlist201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddItemsToWatchlist201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "added": (
                    AddNewRatings201ResponseAdded.from_dict(obj["added"])
                    if obj.get("added") is not None
                    else None
                ),
                "existing": (
                    AddNewRatings201ResponseAdded.from_dict(obj["existing"])
