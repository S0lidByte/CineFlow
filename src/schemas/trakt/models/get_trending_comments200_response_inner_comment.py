...
class GetTrendingComments200ResponseInnerComment(BaseModel):
    """
    ...
    parent_id: Optional[Union[StrictFloat, StrictInt]] = None
    created_at: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    replies: Optional[Union[StrictFloat, StrictInt]] = None
    likes: Optional[Union[StrictFloat, StrictInt]] = None
    user_stats: Optional[GetTrendingComments200ResponseInnerCommentUserStats] = None
    user: Optional[PostAComment201ResponseUser] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTrendingComments200ResponseInnerComment from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of user_stats
        if self.user_stats:
            _dict["user_stats"] = self.user_stats.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTrendingComments200ResponseInnerComment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "likes": obj.get("likes"),
                "user_stats": (
                    GetTrendingComments200ResponseInnerCommentUserStats.from_dict(
                        obj["user_stats"]
                    )
                    if obj.get("user_stats") is not None
                    else None
                ),
                "user": (
                    PostAComment201ResponseUser.from_dict(obj["user"])
