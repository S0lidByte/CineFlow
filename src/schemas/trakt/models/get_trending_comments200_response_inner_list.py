...
class GetTrendingComments200ResponseInnerList(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTrendingComments200ResponseInnerList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTrendingComments200ResponseInnerList from a dict"""
        if obj is None:
            return None
