...
class GetSingleSeasonsForAShow200Response(BaseModel):
    ...
    udpated_at: Optional[StrictStr] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSingleSeasonsForAShow200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSingleSeasonsForAShow200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "ids": (
                    GetTrendingComments200ResponseInnerSeasonIds.from_dict(obj["ids"])
