...
class GetASingleShow200Response(BaseModel):
    """
    ...
    ids: Optional[GetShows200ResponseInnerShowIds] = None
    tagline: Optional[StrictStr] = None
    overview: Optional[StrictStr] = None
    first_aired: Optional[StrictStr] = None
    airs: Optional[GetASingleShow200ResponseAirs] = None
    ...
    comment_count: Optional[Union[StrictFloat, StrictInt]] = None
    languages: Optional[List[StrictStr]] = None
    available_translations: Optional[List[StrictStr]] = None
    genres: Optional[List[StrictStr]] = None
    aired_episodes: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetASingleShow200Response from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of airs
        if self.airs:
            _dict["airs"] = self.airs.to_dict()
        # set to None if trailer (nullable) is None
        # and model_fields_set contains the field
        if self.trailer is None and "trailer" in self.model_fields_set:
            _dict["trailer"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetASingleShow200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "year": obj.get("year"),
                "ids": (
                    GetShows200ResponseInnerShowIds.from_dict(obj["ids"])
                    if obj.get("ids") is not None
                    else None
                ),
                "tagline": obj.get("tagline"),
                "overview": obj.get("overview"),
                "first_aired": obj.get("first_aired"),
                "airs": (
                    GetASingleShow200ResponseAirs.from_dict(obj["airs"])
                    if obj.get("airs") is not None
                    else None
                ),
                ...
                "available_translations": obj.get("available_translations"),
                "genres": obj.get("genres"),
                "aired_episodes": obj.get("aired_episodes"),
