...
class GetAllPeopleForAnEpisode200Response(BaseModel):
    """
    GetAllPeopleForAnEpisode200Response
    """  # noqa: E501

    cast: Optional[List[GetAllPeopleForAMovie200ResponseCastInner]] = None
    guest_stars: Optional[List[GetAllPeopleForAnEpisode200ResponseGuestStarsInner]] = (
        None
    )
    crew: Optional[GetAllPeopleForAnEpisode200ResponseCrew] = None
    __properties: ClassVar[List[str]] = ["cast", "guest_stars", "crew"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAnEpisode200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllPeopleForAnEpisode200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "cast": (
                    [
                        GetAllPeopleForAMovie200ResponseCastInner.from_dict(_item)
                ...
                "guest_stars": (
                    [
                        GetAllPeopleForAnEpisode200ResponseGuestStarsInner.from_dict(
                            _item
                        )
                ...
                "crew": (
                    GetAllPeopleForAnEpisode200ResponseCrew.from_dict(obj["crew"])
