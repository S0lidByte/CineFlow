...
class AddItemsToWatchlistRequest(BaseModel):
    """
    AddItemsToWatchlistRequest
    """  # noqa: E501

    movies: Optional[List[AddItemsToWatchlistRequestMoviesInner]] = None
    shows: Optional[List[AddItemsToWatchlistRequestShowsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "movies": (
                    [
                        AddItemsToWatchlistRequestMoviesInner.from_dict(_item)
                ...
                "shows": (
                    [
                        AddItemsToWatchlistRequestShowsInner.from_dict(_item)
