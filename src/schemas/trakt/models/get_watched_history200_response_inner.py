...
class GetWatchedHistory200ResponseInner(BaseModel):
    """
    GetWatchedHistory200ResponseInner
    """  # noqa: E501

    id: Union[StrictFloat, StrictInt]
    watched_at: StrictStr
    action: StrictStr
    type: StrictStr
    episode: GetItemsOnAList200ResponseInnerEpisode
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWatchedHistory200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWatchedHistory200ResponseInner from a dict"""
        if obj is None:
            return None
