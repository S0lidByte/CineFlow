...
class AddItemsToCollection201Response(BaseModel):
    """
    AddItemsToCollection201Response
    """  # noqa: E501

    added: Optional[AddItemsToCollection201ResponseAdded] = None
    updated: Optional[AddItemsToCollection201ResponseAdded] = None
    existing: Optional[AddItemsToCollection201ResponseAdded] = None
    not_found: Optional[AddItemsToCollection201ResponseNotFound] = None
    __properties: ClassVar[List[str]] = ["added", "updated", "existing", "not_found"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddItemsToCollection201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddItemsToCollection201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "added": (
                    AddItemsToCollection201ResponseAdded.from_dict(obj["added"])
                    if obj.get("added") is not None
                    else None
                ),
                "updated": (
                    AddItemsToCollection201ResponseAdded.from_dict(obj["updated"])
                    if obj.get("updated") is not None
                    else None
                ),
                "existing": (
                    AddItemsToCollection201ResponseAdded.from_dict(obj["existing"])
                    if obj.get("existing") is not None
                    else None
                ),
                "not_found": (
                    AddItemsToCollection201ResponseNotFound.from_dict(obj["not_found"])
