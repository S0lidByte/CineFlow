...
class AddItemsToWatchedHistoryRequest(BaseModel):
    """
    AddItemsToWatchedHistoryRequest
    """  # noqa: E501

    movies: Optional[List[AddItemsToWatchedHistoryRequestMoviesInner]] = None
    shows: Optional[List[AddItemsToWatchedHistoryRequestShowsInner]] = None
    seasons: Optional[List[AddItemsToWatchedHistoryRequestSeasonsInner]] = None
    episodes: Optional[List[AddItemsToWatchedHistoryRequestEpisodesInner]] = None
    __properties: ClassVar[List[str]] = ["movies", "shows", "seasons", "episodes"]
        ...
        _obj = cls.model_validate(
            {
                "movies": (
                    [
                        AddItemsToWatchedHistoryRequestMoviesInner.from_dict(_item)
                ...
                "shows": (
                    [
                        AddItemsToWatchedHistoryRequestShowsInner.from_dict(_item)
                ...
                "seasons": (
                    [
                        AddItemsToWatchedHistoryRequestSeasonsInner.from_dict(_item)
                ...
                "episodes": (
                    [
                        AddItemsToWatchedHistoryRequestEpisodesInner.from_dict(_item)
