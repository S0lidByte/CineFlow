...
class GetShowCollectionProgress200Response(BaseModel):
    """
    ...
    seasons: Optional[List[GetShowCollectionProgress200ResponseSeasonsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetShowCollectionProgress200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetShowCollectionProgress200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "last_collected_at": obj.get("last_collected_at"),
                "seasons": (
                    [
                        GetShowCollectionProgress200ResponseSeasonsInner.from_dict(
                            _item
                        )
