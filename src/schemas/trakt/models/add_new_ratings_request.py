...
class AddNewRatingsRequest(BaseModel):
    """
    AddNewRatingsRequest
    """  # noqa: E501

    movies: Optional[List[AddNewRatingsRequestMoviesInner]] = None
    shows: Optional[List[AddNewRatingsRequestShowsInner]] = None
    seasons: Optional[List[AddNewRatingsRequestSeasonsInner]] = None
    episodes: Optional[List[AddNewRatingsRequestEpisodesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "movies": (
                    [
                        AddNewRatingsRequestMoviesInner.from_dict(_item)
                ...
                "shows": (
                    [
                        AddNewRatingsRequestShowsInner.from_dict(_item)
                ...
                "seasons": (
                    [
                        AddNewRatingsRequestSeasonsInner.from_dict(_item)
                ...
                "episodes": (
                    [
                        AddNewRatingsRequestEpisodesInner.from_dict(_item)
