...
class GetLikes200ResponseInnerList(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLikes200ResponseInnerList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLikes200ResponseInnerList from a dict"""
        if obj is None:
            return None
