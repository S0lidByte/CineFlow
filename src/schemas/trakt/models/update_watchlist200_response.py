...
class UpdateWatchlist200Response(BaseModel):
    """
    ...
    ids: Optional[UpdateWatchlist200ResponseIds] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateWatchlist200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateWatchlist200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "likes": obj.get("likes"),
                "ids": (
                    UpdateWatchlist200ResponseIds.from_dict(obj["ids"])
