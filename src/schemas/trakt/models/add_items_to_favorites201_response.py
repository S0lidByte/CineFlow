...
class AddItemsToFavorites201Response(BaseModel):
    """
    AddItemsToFavorites201Response
    """  # noqa: E501

    added: Optional[AddItemsToFavorites201ResponseAdded] = None
    existing: Optional[AddItemsToFavorites201ResponseAdded] = None
    not_found: Optional[AddItemsToFavorites201ResponseNotFound] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddItemsToFavorites201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddItemsToFavorites201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "added": (
                    AddItemsToFavorites201ResponseAdded.from_dict(obj["added"])
                    if obj.get("added") is not None
                    else None
                ),
                "existing": (
                    AddItemsToFavorites201ResponseAdded.from_dict(obj["existing"])
                    if obj.get("existing") is not None
                    else None
                ),
                "not_found": (
                    AddItemsToFavorites201ResponseNotFound.from_dict(obj["not_found"])
