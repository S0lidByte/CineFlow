...
class GetTrendingComments200ResponseInner(BaseModel):
    """
    GetTrendingComments200ResponseInner
    """  # noqa: E501

    type: StrictStr
    movie: Optional[GetMovies200ResponseInnerMovie] = None
    comment: GetTrendingComments200ResponseInnerComment
    show: GetShows200ResponseInnerShow
    season: Optional[GetTrendingComments200ResponseInnerSeason] = None
    episode: Optional[GetShows200ResponseInnerEpisode] = None
    list: Optional[GetTrendingComments200ResponseInnerList] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTrendingComments200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTrendingComments200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "movie": (
                    GetMovies200ResponseInnerMovie.from_dict(obj["movie"])
                    if obj.get("movie") is not None
                    else None
                ),
                "comment": (
                    GetTrendingComments200ResponseInnerComment.from_dict(obj["comment"])
                    if obj.get("comment") is not None
                    else None
                ),
                "show": (
                    GetShows200ResponseInnerShow.from_dict(obj["show"])
                    if obj.get("show") is not None
                    else None
                ),
                "season": (
                    GetTrendingComments200ResponseInnerSeason.from_dict(obj["season"])
                    if obj.get("season") is not None
                    else None
                ),
                "episode": (
                    GetShows200ResponseInnerEpisode.from_dict(obj["episode"])
                    if obj.get("episode") is not None
                    else None
                ),
                "list": (
                    GetTrendingComments200ResponseInnerList.from_dict(obj["list"])
