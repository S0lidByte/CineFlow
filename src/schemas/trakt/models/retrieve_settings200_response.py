...
class RetrieveSettings200Response(BaseModel):
    """
    RetrieveSettings200Response
    """  # noqa: E501

    user: Optional[RetrieveSettings200ResponseUser] = None
    account: Optional[RetrieveSettings200ResponseAccount] = None
    connections: Optional[RetrieveSettings200ResponseConnections] = None
    sharing_text: Optional[RetrieveSettings200ResponseSharingText] = None
    limits: Optional[RetrieveSettings200ResponseLimits] = None
    permissions: Optional[RetrieveSettings200ResponsePermissions] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetrieveSettings200Response from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sharing_text
        if self.sharing_text:
            _dict["sharing_text"] = self.sharing_text.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetrieveSettings200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "user": (
                    RetrieveSettings200ResponseUser.from_dict(obj["user"])
                    if obj.get("user") is not None
                    else None
                ),
                "account": (
                    RetrieveSettings200ResponseAccount.from_dict(obj["account"])
                    if obj.get("account") is not None
                    else None
                ),
                "connections": (
                    RetrieveSettings200ResponseConnections.from_dict(obj["connections"])
                    if obj.get("connections") is not None
                    else None
                ),
                "sharing_text": (
                    RetrieveSettings200ResponseSharingText.from_dict(
                        obj["sharing_text"]
                    )
                    if obj.get("sharing_text") is not None
                    else None
                ),
                "limits": (
                    RetrieveSettings200ResponseLimits.from_dict(obj["limits"])
                    if obj.get("limits") is not None
                    else None
                ),
                "permissions": (
                    RetrieveSettings200ResponsePermissions.from_dict(obj["permissions"])
