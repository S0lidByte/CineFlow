...
class RetrieveSettings200ResponseLimits(BaseModel):
    """
    RetrieveSettings200ResponseLimits
    """  # noqa: E501

    list: Optional[RetrieveSettings200ResponseLimitsList] = None
    watchlist: Optional[RetrieveSettings200ResponseLimitsWatchlist] = None
    favorites: Optional[RetrieveSettings200ResponseLimitsWatchlist] = None
    search: Optional[RetrieveSettings200ResponseLimitsSearch] = None
    collection: Optional[RetrieveSettings200ResponseLimitsWatchlist] = None
    notes: Optional[RetrieveSettings200ResponseLimitsWatchlist] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetrieveSettings200ResponseLimits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetrieveSettings200ResponseLimits from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "list": (
                    RetrieveSettings200ResponseLimitsList.from_dict(obj["list"])
                    if obj.get("list") is not None
                    else None
                ),
                "watchlist": (
                    RetrieveSettings200ResponseLimitsWatchlist.from_dict(
                        obj["watchlist"]
                    )
                ...
                "search": (
                    RetrieveSettings200ResponseLimitsSearch.from_dict(obj["search"])
                ...
                "notes": (
                    RetrieveSettings200ResponseLimitsWatchlist.from_dict(obj["notes"])
