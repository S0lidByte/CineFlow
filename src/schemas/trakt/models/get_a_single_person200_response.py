...
class GetASinglePerson200Response(BaseModel):
    """
    GetASinglePerson200Response
    """  # noqa: E501

    name: Optional[StrictStr] = None
    ids: Optional[GetMovies200ResponseInnerMovieIds] = None
    social_ids: Optional[GetASinglePerson200ResponseSocialIds] = None
    biography: Optional[StrictStr] = None
    birthday: Optional[StrictStr] = None
    death: Optional[Any] = None
    birthplace: Optional[StrictStr] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetASinglePerson200Response from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of social_ids
        if self.social_ids:
            _dict["social_ids"] = self.social_ids.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetASinglePerson200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "ids": (
                    GetMovies200ResponseInnerMovieIds.from_dict(obj["ids"])
                    if obj.get("ids") is not None
                    else None
                ),
                "social_ids": (
                    GetASinglePerson200ResponseSocialIds.from_dict(obj["social_ids"])
                    if obj.get("social_ids") is not None
                    else None
                ),
