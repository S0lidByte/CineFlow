...
class AddItemsToPersonalList201Response(BaseModel):
    """
    AddItemsToPersonalList201Response
    """  # noqa: E501

    added: Optional[AddItemsToPersonalList201ResponseAdded] = None
    existing: Optional[AddItemsToPersonalList201ResponseAdded] = None
    not_found: Optional[AddItemsToPersonalList201ResponseNotFound] = None
    list: Optional[AddItemsToWatchlist201ResponseList] = None
    __properties: ClassVar[List[str]] = ["added", "existing", "not_found", "list"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddItemsToPersonalList201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddItemsToPersonalList201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "added": (
                    AddItemsToPersonalList201ResponseAdded.from_dict(obj["added"])
                    if obj.get("added") is not None
                    else None
                ),
                "existing": (
                    AddItemsToPersonalList201ResponseAdded.from_dict(obj["existing"])
                    if obj.get("existing") is not None
                    else None
                ),
                "not_found": (
                    AddItemsToPersonalList201ResponseNotFound.from_dict(
                        obj["not_found"]
                    )
                ...
                "list": (
                    AddItemsToWatchlist201ResponseList.from_dict(obj["list"])
