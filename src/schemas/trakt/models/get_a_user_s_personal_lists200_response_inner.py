...
class GetAUserSPersonalLists200ResponseInner(BaseModel):
    """
    ...
    privacy: StrictStr
    share_link: StrictStr
    type: StrictStr
    display_numbers: StrictBool
    allow_comments: StrictBool
    sort_by: StrictStr
    sort_how: StrictStr
    created_at: StrictStr
    updated_at: StrictStr
    item_count: Union[StrictFloat, StrictInt]
    comment_count: Union[StrictFloat, StrictInt]
    likes: Union[StrictFloat, StrictInt]
    ids: GetTrendingComments200ResponseInnerListIds
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAUserSPersonalLists200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAUserSPersonalLists200ResponseInner from a dict"""
        if obj is None:
            return None
