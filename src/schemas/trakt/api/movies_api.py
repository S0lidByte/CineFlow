...
class MoviesApi:
    ...
    def get_a_movie(
        ...
        #### &#10024; Extended Info  Returns a single movie's details.  > ### 🅽🅾🆃🅴 > _When getting `full` extended info, the `status` field can have a value of `released`, `in production`, `post production`, `planned`, `rumored`, or `canceled`._
        ...
        _param = self._get_a_movie_serialize(
            id=id,
    ...
    @validate_call
    def get_a_movie_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAMovie200Response]:
        """Get a movie
    ...
    @validate_call
    def get_a_movie_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def get_all_movie_aliases(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetAllMovieAliases200ResponseInner]:
        ...
        _param = self._get_all_movie_aliases_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetAllMovieAliases200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_movie_aliases_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetAllMovieAliases200ResponseInner]]:
        """Get all movie aliases
    ...
    @validate_call
    def get_all_movie_aliases_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_all_movie_aliases_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/aliases",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_movie_comments(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetRepliesForAComment200ResponseInner]:
        """Get all movie comments

        #### &#128275; OAuth Optional &#128196; Pagination &#128513; Emojis  Returns all top level comments for a movie. By default, the `newest` comments are returned first. Other sorting options include `oldest`, most `likes`, most `replies`, `highest` rated, `lowest` rated, and most `plays`.  > ### 🅽🅾🆃🅴 > _If you send OAuth, comments from blocked users will be automatically filtered out._
        ...
        _param = self._get_all_movie_comments_serialize(
            id=id,
            sort=sort,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetRepliesForAComment200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_movie_comments_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        sort: Annotated[StrictStr, Field(description="how to sort")],
        trakt_api_version: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetRepliesForAComment200ResponseInner]]:
        """Get all movie comments
    ...
    @validate_call
    def get_all_movie_comments_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        sort: Annotated[StrictStr, Field(description="how to sort")],
        trakt_api_version: Annotated[
    ...
    def _get_all_movie_comments_serialize(
        self,
        id,
        sort,
        trakt_api_version,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/comments/{sort}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_all_movie_releases(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        country: Annotated[StrictStr, Field(description="2 character country code")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        trakt_api_key: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetAllMovieReleases200ResponseInner]:
        ...
        _param = self._get_all_movie_releases_serialize(
            id=id,
            country=country,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetAllMovieReleases200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_movie_releases_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        country: Annotated[StrictStr, Field(description="2 character country code")],
        trakt_api_version: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetAllMovieReleases200ResponseInner]]:
        """Get all movie releases
    ...
    @validate_call
    def get_all_movie_releases_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        country: Annotated[StrictStr, Field(description="2 character country code")],
        trakt_api_version: Annotated[
    ...
    def _get_all_movie_releases_serialize(
        self,
        id,
        country,
        trakt_api_version,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/releases/{country}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_all_movie_translations(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetAllMovieTranslations200ResponseInner]:
        ...
        _param = self._get_all_movie_translations_serialize(
            id=id,
            language=language,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetAllMovieTranslations200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_movie_translations_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        language: Annotated[StrictStr, Field(description="2 character language code")],
        trakt_api_version: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetAllMovieTranslations200ResponseInner]]:
        """Get all movie translations
    ...
    @validate_call
    def get_all_movie_translations_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        language: Annotated[StrictStr, Field(description="2 character language code")],
        trakt_api_version: Annotated[
    ...
    def _get_all_movie_translations_serialize(
        self,
        id,
        language,
        trakt_api_version,
    ...
    @validate_call
    def get_all_people_for_a_movie(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _param = self._get_all_people_for_a_movie_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetAllPeopleForAMovie200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_people_for_a_movie_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAllPeopleForAMovie200Response]:
        """Get all people for a movie
    ...
    @validate_call
    def get_all_people_for_a_movie_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_all_people_for_a_movie_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/people",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_videos(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetAllVideos200ResponseInner]:
        """Get all videos

        #### &#10024; Extended Info  Returns all videos including trailers, teasers, clips, and featurettes.
        ...
        _param = self._get_all_videos_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetAllVideos200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_videos_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetAllVideos200ResponseInner]]:
        """Get all videos
    ...
    @validate_call
    def get_all_videos_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_all_videos_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/videos",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_lists_containing_this_movie(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        type: Annotated[
            StrictStr, Field(description="Filter for a specific list type")
        ],
        sort: Annotated[StrictStr, Field(description="How to sort")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetTrendingLists200ResponseInnerList]:
        ...
        _param = self._get_lists_containing_this_movie_serialize(
            id=id,
            type=type,
            sort=sort,
            trakt_api_version=trakt_api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetTrendingLists200ResponseInnerList]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_lists_containing_this_movie_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        type: Annotated[
            StrictStr, Field(description="Filter for a specific list type")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetTrendingLists200ResponseInnerList]]:
        """Get lists containing this movie
    ...
    @validate_call
    def get_lists_containing_this_movie_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        type: Annotated[
            StrictStr, Field(description="Filter for a specific list type")
    ...
    def _get_lists_containing_this_movie_serialize(
        self,
        id,
        type,
        sort,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/lists/{type}/{sort}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_movie_ratings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetMovieRatings200Response]:
        """Get movie ratings
    ...
    def _get_movie_ratings_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/ratings",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_movie_stats(
        ...
        _param = self._get_movie_stats_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_movie_stats_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetMovieStats200Response]:
        """Get movie stats
    ...
    @validate_call
    def get_movie_stats_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_movie_stats_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
    ...
    def get_movie_studios(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetMovieStudios200ResponseInner]:
        """Get movie studios
        ...
        _param = self._get_movie_studios_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetMovieStudios200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_movie_studios_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetMovieStudios200ResponseInner]]:
        """Get movie studios
    ...
    @validate_call
    def get_movie_studios_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_movie_studios_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/studios",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_popular_movies(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetPopularMovies200ResponseInner]:
        """Get popular movies
        ...
        _param = self._get_popular_movies_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetPopularMovies200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_popular_movies_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetPopularMovies200ResponseInner]]:
        """Get popular movies
    ...
    @validate_call
    def get_popular_movies_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _get_popular_movies_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        _request_auth,
    ...
    @validate_call
    def get_recently_updated_movie_trakt_ids(
        self,
        start_date: Annotated[
            StrictStr, Field(description="Updated since this date and time.")
        ],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        #### &#128196; Pagination  Returns all movie Trakt IDs updated since the specified UTC date and time. We recommended storing the `X-Start-Date` header you can be efficient using this method moving forward. By default, `10` results are returned. You can send a `limit` to get up to `100` results per page.  > ### ☣️ 🅸🅼🅿🅾🆁🆃🅰🅽🆃 > _The `start_date` is only accurate to the hour, for caching purposes. Please drop the minutes and seconds from your timestamp to help optimize our cached data. For example, use `2021-07-17T12:00:00Z` and not `2021-07-17T12:23:34Z`._  > ### 🅽🅾🆃🅴 > _The `start_date` can only be a maximum of 30 days in the past._
        ...
        _param = self._get_recently_updated_movie_trakt_ids_serialize(
    ...
    @validate_call
    def get_recently_updated_movie_trakt_ids_with_http_info(
        self,
        start_date: Annotated[
            StrictStr, Field(description="Updated since this date and time.")
        ],
    ...
    @validate_call
    def get_recently_updated_movie_trakt_ids_without_preload_content(
        self,
        start_date: Annotated[
            StrictStr, Field(description="Updated since this date and time.")
        ],
    ...
    def _get_recently_updated_movie_trakt_ids_serialize(
        self,
        start_date,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/updates/id/{start_date}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_recently_updated_movies(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetRecentlyUpdatedMovies200ResponseInner]:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetRecentlyUpdatedMovies200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def get_recently_updated_movies_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetRecentlyUpdatedMovies200ResponseInner]]:
        """Get recently updated movies
    ...
    def _get_recently_updated_movies_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/updates/{start_date}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_related_movies(
        ...
        _param = self._get_related_movies_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_related_movies_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def get_related_movies_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_related_movies_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/related",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_the_most_anticipated_movies(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetTheMostAnticipatedMovies200ResponseInner]:
        ...
        _param = self._get_the_most_anticipated_movies_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetTheMostAnticipatedMovies200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_the_most_anticipated_movies_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetTheMostAnticipatedMovies200ResponseInner]]:
        """Get the most anticipated movies
    ...
    @validate_call
    def get_the_most_anticipated_movies_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _get_the_most_anticipated_movies_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/anticipated",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_the_most_collected_movies(
        self,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetTheMostPlayedMovies200ResponseInner]:
        ...
        _param = self._get_the_most_collected_movies_serialize(
            period=period,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetTheMostPlayedMovies200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_the_most_collected_movies_with_http_info(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetTheMostPlayedMovies200ResponseInner]]:
        """Get the most Collected movies
    ...
    @validate_call
    def get_the_most_collected_movies_without_preload_content(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_the_most_collected_movies_serialize(
        self,
        period,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/collected/{period}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_the_most_favorited_movies(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetTheMostFavoritedMovies200ResponseInner]:
        """Get the most favorited movies

        #### &#128196; Pagination &#10024; Extended Info &#127898; Filters  Returns the most favorited movies in the specified time `period`, defaulting to `weekly`. All stats are relative to the specific time `period`.
        ...
        _param = self._get_the_most_favorited_movies_serialize(
            period=period,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetTheMostFavoritedMovies200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_the_most_favorited_movies_with_http_info(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetTheMostFavoritedMovies200ResponseInner]]:
        """Get the most favorited movies
    ...
    @validate_call
    def get_the_most_favorited_movies_without_preload_content(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_the_most_favorited_movies_serialize(
        self,
        period,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/favorited/{period}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_the_most_played_movies(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _param = self._get_the_most_played_movies_serialize(
            period=period,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_the_most_played_movies_with_http_info(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def get_the_most_played_movies_without_preload_content(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_the_most_played_movies_serialize(
        self,
        period,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/played/{period}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_the_most_watched_movies(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _param = self._get_the_most_watched_movies_serialize(
            period=period,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_the_most_watched_movies_with_http_info(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def get_the_most_watched_movies_without_preload_content(
        self,
        period: Annotated[StrictStr, Field(description="Time period.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_the_most_watched_movies_serialize(
        self,
        period,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/watched/{period}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_the_weekend_box_office(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetTheWeekendBoxOffice200ResponseInner]:
        ...
        _param = self._get_the_weekend_box_office_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetTheWeekendBoxOffice200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_the_weekend_box_office_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetTheWeekendBoxOffice200ResponseInner]]:
        """Get the weekend box office
    ...
    @validate_call
    def get_the_weekend_box_office_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _get_the_weekend_box_office_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/boxoffice",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_trending_movies(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetTrendingMovies200ResponseInner]:
        """Get trending movies

        #### &#128196; Pagination &#10024; Extended Info &#127898; Filters  Returns the most watched movies over the last 24 hours. Movies with the most `watchers` are returned first.
        ...
        _param = self._get_trending_movies_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetTrendingMovies200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_trending_movies_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetTrendingMovies200ResponseInner]]:
        """Get trending movies
    ...
    @validate_call
    def get_trending_movies_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _get_trending_movies_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        _request_auth,
    ...
    @validate_call
    def get_users_watching_right_now(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetUsersWatchingRightNow200ResponseInner]:
        ...
        _param = self._get_users_watching_right_now_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetUsersWatchingRightNow200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_users_watching_right_now_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetUsersWatchingRightNow200ResponseInner]]:
        """Get users watching right now
    ...
    @validate_call
    def get_users_watching_right_now_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_users_watching_right_now_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/movies/{id}/watching",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def refresh_movie_metadata(
        ...
        #### 🔥 VIP Only &#128274; OAuth Required  Queue this movie for a full metadata and image refresh. It might take up to 8 hours for the updated metadata to be availabe through the API.  > ### 🅽🅾🆃🅴 > _If this movie is already queued, a `409` HTTP status code will returned._
        ...
        _param = self._refresh_movie_metadata_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def refresh_movie_metadata_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def refresh_movie_metadata_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _refresh_movie_metadata_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/movies/{id}/refresh",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
