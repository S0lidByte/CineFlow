...
class PeopleApi:
    ...
    def get_a_single_person(
        ...
        _param = self._get_a_single_person_serialize(
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetASinglePerson200Response",
        }
    ...
    @validate_call
    def get_a_single_person_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetASinglePerson200Response]:
        """Get a single person
    ...
    @validate_call
    def get_a_single_person_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_a_single_person_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
    ...
    @validate_call
    def get_lists_containing_this_person(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        type: Annotated[
        ...
        _param = self._get_lists_containing_this_person_serialize(
            id=id,
            type=type,
            sort=sort,
            trakt_api_version=trakt_api_version,
    ...
    @validate_call
    def get_lists_containing_this_person_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        type: Annotated[
            StrictStr, Field(description="Filter for a specific list type")
    ...
    @validate_call
    def get_lists_containing_this_person_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        type: Annotated[
            StrictStr, Field(description="Filter for a specific list type")
    ...
    def _get_lists_containing_this_person_serialize(
        self,
        id,
        type,
        sort,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/people/{id}/lists/{type}/{sort}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_movie_credits(
        ...
        _param = self._get_movie_credits_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetMovieCredits200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_movie_credits_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetMovieCredits200Response]:
        """Get movie credits
    ...
    @validate_call
    def get_movie_credits_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_movie_credits_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/people/{id}/movies",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_recently_updated_people(
        self,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetRecentlyUpdatedPeople200ResponseInner]:
        ...
        _param = self._get_recently_updated_people_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetRecentlyUpdatedPeople200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_recently_updated_people_with_http_info(
        self,
        start_date: Annotated[
            StrictStr, Field(description="Updated since this date and time.")
        ],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetRecentlyUpdatedPeople200ResponseInner]]:
        """Get recently updated people
    ...
    @validate_call
    def get_recently_updated_people_without_preload_content(
        self,
        start_date: Annotated[
            StrictStr, Field(description="Updated since this date and time.")
        ],
    ...
    def _get_recently_updated_people_serialize(
        self,
        start_date,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/people/updates/{start_date}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_recently_updated_people_trakt_ids(
        self,
        start_date: Annotated[
            StrictStr, Field(description="Updated since this date and time.")
        ],
        ...
        _param = self._get_recently_updated_people_trakt_ids_serialize(
            start_date=start_date,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_recently_updated_people_trakt_ids_with_http_info(
        self,
        start_date: Annotated[
            StrictStr, Field(description="Updated since this date and time.")
        ],
    ...
    @validate_call
    def get_recently_updated_people_trakt_ids_without_preload_content(
        self,
        start_date: Annotated[
            StrictStr, Field(description="Updated since this date and time.")
        ],
    ...
    def _get_recently_updated_people_trakt_ids_serialize(
        self,
        start_date,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/people/updates/id/{start_date}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_show_credits(
        ...
        _param = self._get_show_credits_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_show_credits_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetShowCredits200Response]:
        """Get show credits
    ...
    @validate_call
    def get_show_credits_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_show_credits_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
    ...
    def refresh_person_metadata(
        ...
        #### 🔥 VIP Only &#128274; OAuth Required  Queue this person for a full metadata and image refresh. It might take up to 8 hours for the updated metadata to be availabe through the API.  > ### 🅽🅾🆃🅴 > _If this person is already queued, a `409` HTTP status code will returned._
        ...
        _param = self._refresh_person_metadata_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def refresh_person_metadata_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def refresh_person_metadata_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _refresh_person_metadata_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/people/{id}/refresh",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
