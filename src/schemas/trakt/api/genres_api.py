...
class GenresApi:
    ...
    def get_genres(
        ...
        Get a list of all genres, including names and slugs.  #### Subgenres  Send `?extended=subgenres` to get a list of subgenres for each genre. You can get more creative with advanced filters by using the subgenres in your app.
