...
class ScrobbleApi:
    ...
    @validate_call
    def start_watching_in_a_media_center(
        self,
        ...
        start_watching_in_a_media_center_request: Optional[
            StartWatchingInAMediaCenterRequest
        ] = None,
        ...
        #### &#128274; OAuth Required  Use this method when the video initially starts playing or is unpaused. This will remove any playback progress if it exists.  > ### 🅽🅾🆃🅴 > _A watching status will auto expire after the remaining runtime has elapsed. There is no need to call this method again while continuing to watch the same item._  #### JSON POST Data  | Key | Type | Value | |---|---|---| | item <span style=\"color:red;\">*</a> | object | `movie` or `episode` object. (see examples &#8594;) | | `progress` <span style=\"color:red;\">*</a> | float | Progress percentage between 0 and 100. |

        :param trakt_api_version: e.g. 2
        :type trakt_api_version: str
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param start_watching_in_a_media_center_request:
        :type start_watching_in_a_media_center_request: StartWatchingInAMediaCenterRequest
        ...
        _param = self._start_watching_in_a_media_center_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            start_watching_in_a_media_center_request=start_watching_in_a_media_center_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "201": "StartWatchingInAMediaCenter201Response",
        }
    ...
    @validate_call
    def start_watching_in_a_media_center_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StartWatchingInAMediaCenter201Response]:
        """Start watching in a media center
    ...
    @validate_call
    def start_watching_in_a_media_center_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _start_watching_in_a_media_center_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        ...
        if start_watching_in_a_media_center_request is not None:
            _body_params = start_watching_in_a_media_center_request
    ...
    @validate_call
    def stop_or_finish_watching_in_a_media_center(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        stop_or_finish_watching_in_a_media_center_request: Optional[
            StopOrFinishWatchingInAMediaCenterRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        #### &#128274; OAuth Required  Use this method when the video is stopped or finishes playing on its own. If the progress is above 80%, the video will be scrobbled and the `action` will be set to **scrobble**. A unique history `id` (64-bit integer) will be returned and can be used to reference this `scrobble` directly.  If the progress is between 1% and 79%, it will be treated as a *pause* and the `action` will be set to **pause**. The playback progress will be saved and [**/sync/playback**](/reference/sync/playback/) can be used to resume the video from this exact position.  > ### 🅽🅾🆃🅴 > _If the progress is less than 1%, you'll get a `422` HTTP status code response and the scrobble will be ignored._  #### JSON POST Data  | Key | Type | Value | |---|---|---| | item <span style=\"color:red;\">*</a> | object | `movie` or `episode` object. (see examples &#8594;) | | `progress` <span style=\"color:red;\">*</a> | flloat | Progress percentage between 0 and 100. |  > ### 🅽🅾🆃🅴 > _If the same item was just scrobbled, a `409` HTTP status code will returned to avoid scrobbling a duplicate. The response will contain a `watched_at` timestamp when the item was last scrobbled and a `expires_at` timestamp when the item can be scrobbled again._

        :param trakt_api_version: e.g. 2
        :type trakt_api_version: str
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param stop_or_finish_watching_in_a_media_center_request:
        :type stop_or_finish_watching_in_a_media_center_request: StopOrFinishWatchingInAMediaCenterRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._stop_or_finish_watching_in_a_media_center_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            stop_or_finish_watching_in_a_media_center_request=stop_or_finish_watching_in_a_media_center_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "201": "StopOrFinishWatchingInAMediaCenter201Response",
            "409": "StopOrFinishWatchingInAMediaCenter409Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def stop_or_finish_watching_in_a_media_center_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StopOrFinishWatchingInAMediaCenter201Response]:
        """Stop or finish watching in a media center
    ...
    @validate_call
    def stop_or_finish_watching_in_a_media_center_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _stop_or_finish_watching_in_a_media_center_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        ...
        # process the form parameters
        # process the body parameter
        if stop_or_finish_watching_in_a_media_center_request is not None:
            _body_params = stop_or_finish_watching_in_a_media_center_request
