...
class NotesApi:
    ...
    def add_notes(
        ...
        add_notes_request: Optional[AddNotesRequest] = None,
        ...
        #### 🔥 VIP Enhanced &#128274; OAuth Required &#128513; Emojis  Notes *(500 maximum characters)* added to a `movie`, `show`, `season`, `episode`, or `person` will automatically be set to `private`. You can send just the media item.  Notes *(500 maximum characters)* added to a `history`, `collection`, or `rating` can have their `privacy` and `spoiler` set. You need to send the `attached_to` object so we know where to attach the note.  #### Limits  If the user's note limit is exceeded, a `420` HTTP error code is returned. Use the [**/users/settings**](/reference/users/settings) method to get all limits for a user account. Upgrading to [**Trakt VIP**](https://trakt.tv/vip) allows for unlimited notes.  #### JSON POST Data  | Key | Type | Default | Value | |---|---|---|---| | item <span style=\"color:red;\">*</a> | object | | `movie`, `show`, `season`, `episode`, `person`, 'history', 'collection', 'rating' object. (see examples &#8594;) | | `notes` <span style=\"color:red;\">*</a> | string |  | Text for the notes. | | `spoiler` | boolean | `false` | Is this a spoiler? | | `privacy` | string | `private` | `private`, `friends`, `public` |

        :param trakt_api_version: e.g. 2
        :type trakt_api_version: str
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param add_notes_request:
        :type add_notes_request: AddNotesRequest
        ...
        _param = self._add_notes_serialize(
    ...
    def add_notes_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddNotes201Response]:
        """Add notes
    ...
    @validate_call
    def add_notes_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _add_notes_serialize(
        ...
        if add_notes_request is not None:
            _body_params = add_notes_request
    ...
    def delete_a_note(
        self,
        id: Annotated[StrictInt, Field(description="A specific note ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        trakt_api_key: Annotated[
        ...
        #### &#128274; OAuth Required  Delete a single note. The OAuth user must match the author of the comment in order to delete it. If not, a `401` HTTP status code is returned.

        :param id: A specific note ID. (required)
        :type id: int
        :param trakt_api_version: e.g. 2
        :type trakt_api_version: str
        :param trakt_api_key: e.g. [client_id]
        ...
        _param = self._delete_a_note_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_a_note_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific note ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def delete_a_note_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific note ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def get_a_note(
        ...
        #### &#128274; OAuth Required &#128513; Emojis  Returns a single note.
        ...
        _param = self._get_a_note_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    def get_a_note_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetANote200Response]:
        """Get a note
    ...
    @validate_call
    def get_a_note_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific note ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def get_the_attached_item(
        ...
        _param = self._get_the_attached_item_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetTheAttachedItem200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_the_attached_item_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific note ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTheAttachedItem200Response]:
        """Get the attached item
    ...
    @validate_call
    def get_the_attached_item_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific note ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_the_attached_item_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
    ...
    def update_a_note(
        ...
        update_a_note_request: Optional[UpdateANoteRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        #### &#128274; OAuth Required &#128513; Emojis  Update a single note *(500 maximum characters)*. The OAuth user must match the author of the note in order to update it. If not, a `401` HTTP status is returned.  #### JSON POST Data  | Key | Type | Default | Value | |---|---|---|---| | `notes` | string |  | Text for the notes. | | `spoiler` | boolean | `false` | Is this a spoiler? | | `privacy` | string | `private` | `private`, `friends`, `public` |
        ...
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param update_a_note_request:
        :type update_a_note_request: UpdateANoteRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_a_note_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            update_a_note_request=update_a_note_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def update_a_note_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific note ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateANote200Response]:
        """Update a note
    ...
    @validate_call
    def update_a_note_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific note ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _update_a_note_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        update_a_note_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_a_note_request is not None:
            _body_params = update_a_note_request
