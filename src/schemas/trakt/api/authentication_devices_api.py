...
class AuthenticationDevicesApi:
    ...
    @validate_call
    def generate_new_device_codes(
        self,
        generate_new_device_codes_request: Optional[
            GenerateNewDeviceCodesRequest
        ] = None,
        ...
        :param generate_new_device_codes_request:
        :type generate_new_device_codes_request: GenerateNewDeviceCodesRequest
        ...
        _param = self._generate_new_device_codes_serialize(
            generate_new_device_codes_request=generate_new_device_codes_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GenerateNewDeviceCodes200Response",
        }
    ...
    @validate_call
    def generate_new_device_codes_with_http_info(
        self,
        generate_new_device_codes_request: Optional[
            GenerateNewDeviceCodesRequest
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GenerateNewDeviceCodes200Response]:
        """Generate new device codes
    ...
    @validate_call
    def generate_new_device_codes_without_preload_content(
        self,
        generate_new_device_codes_request: Optional[
            GenerateNewDeviceCodesRequest
        ] = None,
    ...
    def _generate_new_device_codes_serialize(
        self,
        ...
        if generate_new_device_codes_request is not None:
            _body_params = generate_new_device_codes_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/oauth/device/code",
    ...
    @validate_call
    def poll_for_the_access_token(
        self,
        poll_for_the_access_token_request: Optional[
            PollForTheAccessTokenRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        :param poll_for_the_access_token_request:
        :type poll_for_the_access_token_request: PollForTheAccessTokenRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._poll_for_the_access_token_serialize(
            poll_for_the_access_token_request=poll_for_the_access_token_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def poll_for_the_access_token_with_http_info(
        self,
        poll_for_the_access_token_request: Optional[
            PollForTheAccessTokenRequest
        ] = None,
    ...
    @validate_call
    def poll_for_the_access_token_without_preload_content(
        self,
        poll_for_the_access_token_request: Optional[
            PollForTheAccessTokenRequest
        ] = None,
    ...
    def _poll_for_the_access_token_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if poll_for_the_access_token_request is not None:
            _body_params = poll_for_the_access_token_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/oauth/device/token",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
