...
class SeasonsApi:
    ...
    @validate_call
    def get_all_episodes_for_a_single_season(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        translations: Annotated[
            Optional[StrictStr], Field(description="include episode translations")
        ] = None,
    ...
    ) -> List[GetAllEpisodesForASingleSeason200ResponseInner]:
        """Get all episodes for a single season

        #### &#10024; Extended Info  Returns all episodes for a specific season of a show.  #### Translations  If you'd like to included translated episode titles and overviews in the response, include the `translations` parameter in the URL. Include all languages by setting the parameter to `all` or use a specific 2 digit country language code to further limit it.  > ### 🅽🅾🆃🅴 > _This returns a lot of data, so please only use this extended parameter if you actually need it!_
        ...
        _param = self._get_all_episodes_for_a_single_season_serialize(
            id=id,
            season=season,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetAllEpisodesForASingleSeason200ResponseInner]",
        }
    ...
    @validate_call
    def get_all_episodes_for_a_single_season_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        translations: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetAllEpisodesForASingleSeason200ResponseInner]]:
        """Get all episodes for a single season
    ...
    @validate_call
    def get_all_episodes_for_a_single_season_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        translations: Annotated[
    ...
    def _get_all_episodes_for_a_single_season_serialize(
        self,
        id,
        season,
        translations,
        ...
        if translations is not None:
            ...
            _query_params.append(("translations", translations))
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}",
    ...
    @validate_call
    def get_all_people_for_a_season(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
        ...
        _param = self._get_all_people_for_a_season_serialize(
            id=id,
            season=season,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetAllPeopleForASeason200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_people_for_a_season_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAllPeopleForASeason200Response]:
        """Get all people for a season
    ...
    @validate_call
    def get_all_people_for_a_season_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
    ...
    def _get_all_people_for_a_season_serialize(
        self,
        id,
        season,
        trakt_api_version,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/people",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_season_comments(
        ...
        _param = self._get_all_season_comments_serialize(
            id=id,
            season=season,
            sort=sort,
            trakt_api_version=trakt_api_version,
    ...
    @validate_call
    def get_all_season_comments_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        sort: Annotated[StrictStr, Field(description="how to sort")],
    ...
    @validate_call
    def get_all_season_comments_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        sort: Annotated[StrictStr, Field(description="how to sort")],
    ...
    def _get_all_season_comments_serialize(
        self,
        id,
        season,
        sort,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/comments/{sort}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_all_season_translations(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetAllSeasonTranslations200ResponseInner]:
        ...
        _param = self._get_all_season_translations_serialize(
            id=id,
            season=season,
            language=language,
            trakt_api_version=trakt_api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetAllSeasonTranslations200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_season_translations_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        language: Annotated[StrictStr, Field(description="2 character language code")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetAllSeasonTranslations200ResponseInner]]:
        """Get all season translations
    ...
    @validate_call
    def get_all_season_translations_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        language: Annotated[StrictStr, Field(description="2 character language code")],
    ...
    def _get_all_season_translations_serialize(
        self,
        id,
        season,
        language,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/translations/{language}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_all_seasons_for_a_show(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetAllSeasonsForAShow200ResponseInner]:
        """Get all seasons for a show

        #### &#10024; Extended Info  Returns all seasons for a show including the number of episodes in each season.  #### Episodes  If you add `?extended=episodes` to the URL, it will return all episodes for all seasons.  > ### 🅽🅾🆃🅴 > _This returns a lot of data, so please only use this extended parameter if you actually need it!_
        ...
        _param = self._get_all_seasons_for_a_show_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetAllSeasonsForAShow200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_seasons_for_a_show_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetAllSeasonsForAShow200ResponseInner]]:
        """Get all seasons for a show
    ...
    @validate_call
    def get_all_seasons_for_a_show_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_all_seasons_for_a_show_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_all_videos_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/videos",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_lists_containing_this_season(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        type: Annotated[
        ...
        _param = self._get_lists_containing_this_season_serialize(
            id=id,
            season=season,
            type=type,
            sort=sort,
    ...
    @validate_call
    def get_lists_containing_this_season_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        type: Annotated[
    ...
    @validate_call
    def get_lists_containing_this_season_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        type: Annotated[
    ...
    def _get_lists_containing_this_season_serialize(
        self,
        id,
        season,
        type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/lists/{type}/{sort}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_season_ratings(
        ...
        _param = self._get_season_ratings_serialize(
            id=id,
            season=season,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetSeasonRatings200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_season_ratings_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSeasonRatings200Response]:
        """Get season ratings
    ...
    @validate_call
    def get_season_ratings_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
    ...
    def _get_season_ratings_serialize(
        self,
        id,
        season,
        trakt_api_version,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/ratings",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_season_stats(
        ...
        _param = self._get_season_stats_serialize(
            id=id,
            season=season,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
    ...
    @validate_call
    def get_season_stats_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSeasonStats200Response]:
        """Get season stats
    ...
    @validate_call
    def get_season_stats_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
    ...
    def _get_season_stats_serialize(
        self,
        id,
        season,
        trakt_api_version,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/stats",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_single_seasons_for_a_show(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
        ...
        #### &#10024; Extended Info  Returns a single seasons for a show.
        ...
        _param = self._get_single_seasons_for_a_show_serialize(
            id=id,
            season=season,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetSingleSeasonsForAShow200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_single_seasons_for_a_show_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSingleSeasonsForAShow200Response]:
        """Get single seasons for a show
    ...
    @validate_call
    def get_single_seasons_for_a_show_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        trakt_api_version: Annotated[
    ...
    def _get_single_seasons_for_a_show_serialize(
        self,
        id,
        season,
        trakt_api_version,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/info",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_users_watching_right_now_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/watching",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
