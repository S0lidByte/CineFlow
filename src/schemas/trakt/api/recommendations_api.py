...
class RecommendationsApi:
    ...
    def get_movie_recommendations(
        ...
        ignore_collected: Annotated[
            Optional[StrictStr], Field(description="filter out collected movies")
        ] = None,
        ignore_watchlisted: Annotated[
            Optional[StrictStr], Field(description="filter out watchlisted movies")
        ] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetMovieRecommendations200ResponseInner]",
        }
    ...
    def get_movie_recommendations_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetMovieRecommendations200ResponseInner]]:
        """Get movie recommendations
    ...
    def _get_movie_recommendations_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/recommendations/movies",
    ...
    def get_show_recommendations(
        self,
        ignore_collected: Annotated[
            Optional[StrictStr], Field(description="filter out collected shows")
        ] = None,
        ignore_watchlisted: Annotated[
            Optional[StrictStr], Field(description="filter out watchlisted movies")
        ] = None,
        ...
        _param = self._get_show_recommendations_serialize(
            ignore_collected=ignore_collected,
            ignore_watchlisted=ignore_watchlisted,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetShowRecommendations200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_show_recommendations_with_http_info(
        self,
        ignore_collected: Annotated[
            Optional[StrictStr], Field(description="filter out collected shows")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetShowRecommendations200ResponseInner]]:
        """Get show recommendations
    ...
    @validate_call
    def get_show_recommendations_without_preload_content(
        self,
        ignore_collected: Annotated[
            Optional[StrictStr], Field(description="filter out collected shows")
        ] = None,
    ...
    def _get_show_recommendations_serialize(
        self,
        ignore_collected,
        ignore_watchlisted,
        trakt_api_version,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/recommendations/shows",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def hide_a_movie_recommendation(
        self,
        ...
        _param = self._hide_a_movie_recommendation_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def hide_a_movie_recommendation_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def hide_a_movie_recommendation_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _hide_a_movie_recommendation_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/recommendations/movies/{id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def hide_a_show_recommendation(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _param = self._hide_a_show_recommendation_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def hide_a_show_recommendation_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def hide_a_show_recommendation_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _hide_a_show_recommendation_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/recommendations/shows/{id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
