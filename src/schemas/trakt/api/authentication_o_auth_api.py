...
class AuthenticationOAuthApi:
    ...
    def authorize_application(
        self,
        response_type: Annotated[StrictStr, Field(description="Must be set to code.")],
        client_id: Annotated[
            StrictStr, Field(description="Get this from your app settings.")
        ],
        redirect_uri: Annotated[
            StrictStr, Field(description="URI specified in your app settings.")
        ],
        state: Annotated[
            Optional[StrictStr], Field(description="State variable for CSRF purposes.")
        ] = None,
        body: Annotated[
            Optional[StrictStr], Field(description="Default to the sign up page.")
        ] = None,
        ...
        Construct then redirect to this URL. The Trakt website will request permissions for your app, which the user needs to approve. If the user isn't signed into Trakt, it will ask them to do so.  > ### ☣️ 🅸🅼🅿🅾🆁🆃🅰🅽🆃 > _Use the website **https://trakt.tv** hostname when creating this URL and not the API URL._  #### Optional URL Parameters  When building the authorization URL, you can optionally include the following query parameters in the URL.  | Parameter | Value | Description | |---|---|---| | `signup` | `true` | Prefer the account sign up page to be the default. | | `prompt` | `login` | Force the user to sign in and authorize your app. |

        :param response_type: Must be set to code. (required)
        :type response_type: str
        :param client_id: Get this from your app settings. (required)
        :type client_id: str
        :param redirect_uri: URI specified in your app settings. (required)
        ...
        _param = self._authorize_application_serialize(
    ...
    @validate_call
    def authorize_application_with_http_info(
        self,
        response_type: Annotated[StrictStr, Field(description="Must be set to code.")],
        client_id: Annotated[
            StrictStr, Field(description="Get this from your app settings.")
    ...
    @validate_call
    def authorize_application_without_preload_content(
        self,
        response_type: Annotated[StrictStr, Field(description="Must be set to code.")],
        client_id: Annotated[
            StrictStr, Field(description="Get this from your app settings.")
    ...
    def _authorize_application_serialize(
        self,
        response_type,
        client_id,
        redirect_uri,
    ...
    def exchange_refresh_token_for_access_token(
        self,
        exchange_refresh_token_for_access_token_request: Optional[
            ExchangeRefreshTokenForAccessTokenRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._exchange_refresh_token_for_access_token_serialize(
            exchange_refresh_token_for_access_token_request=exchange_refresh_token_for_access_token_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ExchangeRefreshTokenForAccessToken200Response",
            "401": "ExchangeRefreshTokenForAccessToken401Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def exchange_refresh_token_for_access_token_with_http_info(
        self,
        exchange_refresh_token_for_access_token_request: Optional[
            ExchangeRefreshTokenForAccessTokenRequest
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExchangeRefreshTokenForAccessToken200Response]:
        """Exchange refresh_token for access_token
    ...
    @validate_call
    def exchange_refresh_token_for_access_token_without_preload_content(
        self,
        exchange_refresh_token_for_access_token_request: Optional[
            ExchangeRefreshTokenForAccessTokenRequest
        ] = None,
    ...
    def _exchange_refresh_token_for_access_token_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if exchange_refresh_token_for_access_token_request is not None:
            _body_params = exchange_refresh_token_for_access_token_request
    ...
    @validate_call
    def revoke_an_access_token(
        self,
        revoke_an_access_token_request: Optional[RevokeAnAccessTokenRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param revoke_an_access_token_request:
        :type revoke_an_access_token_request: RevokeAnAccessTokenRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._revoke_an_access_token_serialize(
            revoke_an_access_token_request=revoke_an_access_token_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def revoke_an_access_token_with_http_info(
        self,
        revoke_an_access_token_request: Optional[RevokeAnAccessTokenRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def revoke_an_access_token_without_preload_content(
        self,
        revoke_an_access_token_request: Optional[RevokeAnAccessTokenRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _revoke_an_access_token_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if revoke_an_access_token_request is not None:
            _body_params = revoke_an_access_token_request
