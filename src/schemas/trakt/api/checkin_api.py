...
class CheckinApi:
    ...
    def check_into_an_item(
        ...
        check_into_an_item_request: Optional[CheckIntoAnItemRequest] = None,
        ...
        _param = self._check_into_an_item_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            check_into_an_item_request=check_into_an_item_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "201": "CheckIntoAnItem201Response",
            "409": "CheckIntoAnItem409Response",
        }
    ...
    @validate_call
    def check_into_an_item_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CheckIntoAnItem201Response]:
        """Check into an item
    ...
    @validate_call
    def check_into_an_item_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _check_into_an_item_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        ...
        if check_into_an_item_request is not None:
            _body_params = check_into_an_item_request
    ...
    @validate_call
    def delete_any_active_checkins(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _param = self._delete_any_active_checkins_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_any_active_checkins_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    @validate_call
    def delete_any_active_checkins_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _delete_any_active_checkins_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        _request_auth,
