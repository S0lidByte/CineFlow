...
class CertificationsApi:
    ...
    def get_certifications(
        ...
        _param = self._get_certifications_serialize(
            type=type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetCertifications200Response",
        }
    ...
    @validate_call
    def get_certifications_with_http_info(
        self,
        type: StrictStr,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCertifications200Response]:
        """Get certifications
    ...
    @validate_call
    def get_certifications_without_preload_content(
        self,
        type: StrictStr,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_certifications_serialize(
        self,
        type,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/certifications/{type}",
