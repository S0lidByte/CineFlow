...
class CommentsApi:
    ...
    @validate_call
    def delete_a_comment_or_reply(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        ...
        _param = self._delete_a_comment_or_reply_serialize(
            id=id,
    ...
    @validate_call
    def delete_a_comment_or_reply_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def delete_a_comment_or_reply_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _delete_a_comment_or_reply_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
    ...
    def get_a_comment_or_reply(
        ...
        _param = self._get_a_comment_or_reply_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetACommentOrReply200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_a_comment_or_reply_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetACommentOrReply200Response]:
        """Get a comment or reply
    ...
    @validate_call
    def get_a_comment_or_reply_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_a_comment_or_reply_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
    ...
    @validate_call
    def get_all_users_who_liked_a_comment(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _param = self._get_all_users_who_liked_a_comment_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_all_users_who_liked_a_comment_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def get_all_users_who_liked_a_comment_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_all_users_who_liked_a_comment_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/comments/{id}/likes",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_recently_created_comments(
        self,
        ...
        _param = self._get_recently_created_comments_serialize(
    ...
    @validate_call
    def get_recently_created_comments_with_http_info(
        self,
        comment_type: StrictStr,
        type: StrictStr,
        include_replies: Annotated[
    ...
    @validate_call
    def get_recently_created_comments_without_preload_content(
        self,
        comment_type: StrictStr,
        type: StrictStr,
        include_replies: Annotated[
    ...
    def _get_recently_created_comments_serialize(
        self,
        comment_type,
        type,
        include_replies,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/comments/recent/{comment_type}/{type}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_recently_updated_comments(
        self,
        comment_type: StrictStr,
        type: StrictStr,
        include_replies: Annotated[
        ...
        _param = self._get_recently_updated_comments_serialize(
            comment_type=comment_type,
            type=type,
            include_replies=include_replies,
            trakt_api_version=trakt_api_version,
    ...
    @validate_call
    def get_recently_updated_comments_with_http_info(
        self,
        comment_type: StrictStr,
        type: StrictStr,
        include_replies: Annotated[
    ...
    @validate_call
    def get_recently_updated_comments_without_preload_content(
        self,
        comment_type: StrictStr,
        type: StrictStr,
        include_replies: Annotated[
    ...
    def _get_recently_updated_comments_serialize(
        self,
        comment_type,
        type,
        include_replies,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/comments/updates/{comment_type}/{type}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_replies_for_a_comment(
        ...
        #### &#128275; OAuth Optional &#128196; Pagination &#128513; Emojis  Returns all replies for a comment. It is possible these replies could have replies themselves, so in that case you would just call [**/comments/:id/replies**](/reference/comments/replies/) again with the new comment `id`.  > ### 🅽🅾🆃🅴 > _If you send OAuth, replies from blocked users will be automatically filtered out._
        ...
        _param = self._get_replies_for_a_comment_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_replies_for_a_comment_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def get_replies_for_a_comment_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_replies_for_a_comment_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/comments/{id}/replies",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_the_attached_media_item(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _param = self._get_the_attached_media_item_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetTheAttachedMediaItem200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_the_attached_media_item_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTheAttachedMediaItem200Response]:
        """Get the attached media item
    ...
    @validate_call
    def get_the_attached_media_item_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_the_attached_media_item_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/comments/{id}/item",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_trending_comments(
        ...
        _param = self._get_trending_comments_serialize(
            comment_type=comment_type,
            type=type,
            include_replies=include_replies,
            trakt_api_version=trakt_api_version,
    ...
    @validate_call
    def get_trending_comments_with_http_info(
        self,
        comment_type: StrictStr,
        type: StrictStr,
        include_replies: Annotated[
    ...
    @validate_call
    def get_trending_comments_without_preload_content(
        self,
        comment_type: StrictStr,
        type: StrictStr,
        include_replies: Annotated[
    ...
    def _get_trending_comments_serialize(
        self,
        comment_type,
        type,
        include_replies,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/comments/trending/{comment_type}/{type}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def like_a_comment(
        ...
        _param = self._like_a_comment_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def like_a_comment_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def like_a_comment_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _like_a_comment_serialize(
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/comments/{id}/like",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def post_a_comment(
        ...
        post_a_comment_request: Optional[PostACommentRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param post_a_comment_request:
        :type post_a_comment_request: PostACommentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_a_comment_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            post_a_comment_request=post_a_comment_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def post_a_comment_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostAComment201Response]:
        """Post a comment
    ...
    @validate_call
    def post_a_comment_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _post_a_comment_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if post_a_comment_request is not None:
            _body_params = post_a_comment_request
    ...
    @validate_call
    def post_a_reply_for_a_comment(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        post_a_reply_for_a_comment_request: Optional[
            PostAReplyForACommentRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        #### &#128274; OAuth Required &#128513; Emojis  Add a new reply to an existing comment. Make sure to allow and encourage *spoilers* to be indicated in your app and follow the rules listed above.  > ### 🅽🅾🆃🅴 > Replies can only be added to top level comments. If you try to reply to a reply, a `404` HTTP status code is returned.  #### JSON POST Data  | Key | Type | Default | Value | |---|---|---|---| | `comment` <span style=\"color:red;\">*</a> | string |  | Text for the reply. | | `spoiler` | boolean | `false` | Is this a spoiler? |
        ...
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param post_a_reply_for_a_comment_request:
        :type post_a_reply_for_a_comment_request: PostAReplyForACommentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_a_reply_for_a_comment_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            post_a_reply_for_a_comment_request=post_a_reply_for_a_comment_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "201": "PostAReplyForAComment201Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def post_a_reply_for_a_comment_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostAReplyForAComment201Response]:
        """Post a reply for a comment
    ...
    @validate_call
    def post_a_reply_for_a_comment_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _post_a_reply_for_a_comment_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        # process the form parameters
        # process the body parameter
        if post_a_reply_for_a_comment_request is not None:
            _body_params = post_a_reply_for_a_comment_request
    ...
    def remove_like_on_a_comment(
        ...
        _param = self._remove_like_on_a_comment_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def remove_like_on_a_comment_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def remove_like_on_a_comment_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _remove_like_on_a_comment_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
    ...
    def update_a_comment_or_reply(
        ...
        update_a_comment_or_reply_request: Optional[
            UpdateACommentOrReplyRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param update_a_comment_or_reply_request:
        :type update_a_comment_or_reply_request: UpdateACommentOrReplyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_a_comment_or_reply_serialize(
            id=id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            update_a_comment_or_reply_request=update_a_comment_or_reply_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "UpdateACommentOrReply200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def update_a_comment_or_reply_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateACommentOrReply200Response]:
        """Update a comment or reply
    ...
    @validate_call
    def update_a_comment_or_reply_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A specific comment ID.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _update_a_comment_or_reply_serialize(
        self,
        id,
        trakt_api_version,
        trakt_api_key,
        ...
        # process the form parameters
        # process the body parameter
        if update_a_comment_or_reply_request is not None:
            _body_params = update_a_comment_or_reply_request
