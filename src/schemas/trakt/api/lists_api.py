...
class ListsApi:
    ...
    def get_all_list_comments(
        self,
        id: Annotated[StrictInt, Field(description="Trakt ID")],
    ...
    def _get_all_list_comments_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/lists/{id}/comments/{sort}",
    ...
    def get_all_users_who_liked_a_list(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        trakt_api_key: Annotated[
    ...
    def get_items_on_a_list(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetItemsOnAList200ResponseInner]:
        """Get items on a list
        ...
        _param = self._get_items_on_a_list_serialize(
            id=id,
            type=type,
            sort_by=sort_by,
            sort_how=sort_how,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetItemsOnAList200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_items_on_a_list_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID")],
        type: Annotated[
            StrictStr, Field(description="Filter for a specific item type")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetItemsOnAList200ResponseInner]]:
        """Get items on a list
    ...
    @validate_call
    def get_items_on_a_list_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID")],
        type: Annotated[
            StrictStr, Field(description="Filter for a specific item type")
    ...
    def _get_items_on_a_list_serialize(
        self,
        id,
        type,
        sort_by,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/lists/{id}/items/{type}/{sort_by}/{sort_how}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_list(
        ...
        #### &#128513; Emojis  Returns a single list. Use the [**/lists/:id/items**](#reference/lists/list-items) method to get the actual items this list contains.  > ### 🅽🅾🆃🅴 > _You must use an integer `id`, and only public lists will return data._
    ...
    def get_popular_lists(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetTrendingLists200ResponseInner]:
        """Get popular lists
        ...
        _param = self._get_popular_lists_serialize(
            type=type,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetTrendingLists200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_popular_lists_with_http_info(
        self,
        type: StrictStr,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetTrendingLists200ResponseInner]]:
        """Get popular lists
    ...
    @validate_call
    def get_popular_lists_without_preload_content(
        self,
        type: StrictStr,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_popular_lists_serialize(
        self,
        type,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/lists/popular/{type}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_trending_lists(
        ...
        _param = self._get_trending_lists_serialize(
            type=type,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_trending_lists_with_http_info(
        self,
        type: StrictStr,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def get_trending_lists_without_preload_content(
        self,
        type: StrictStr,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _get_trending_lists_serialize(
        self,
        type,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/lists/trending/{type}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
