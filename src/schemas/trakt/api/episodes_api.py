...
class EpisodesApi:
    ...
    @validate_call
    def get_a_single_episode_for_a_show(
        self,
        ...
        episode: Annotated[StrictInt, Field(description="episode number")],
        ...
        #### &#10024; Extended Info  Returns a single episode's details. All date and times are in UTC and were calculated using the episode's `air_date` and show's `country` and `air_time`.  > ### 🅽🅾🆃🅴 > _If the `first_aired` is unknown, it will be set to `null`._  > ### 🅽🅾🆃🅴 > _When getting `full` extended info, the `episode_type` field can have a value of `standard`, `series_premiere` (season 1, episode 1), `season_premiere` (episode 1), `mid_season_finale`, `mid_season_premiere` (the next episode after the mid season finale), `season_finale`, or `series_finale` (last episode to air for an ended show)._
        ...
        _param = self._get_a_single_episode_for_a_show_serialize(
            id=id,
            season=season,
            episode=episode,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetASingleEpisodeForAShow200Response",
        }
    ...
    @validate_call
    def get_a_single_episode_for_a_show_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetASingleEpisodeForAShow200Response]:
        """Get a single episode for a show
    ...
    @validate_call
    def get_a_single_episode_for_a_show_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    def _get_a_single_episode_for_a_show_serialize(
        self,
        id,
        season,
        episode,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/episodes/{episode}",
    ...
    def get_all_episode_comments(
        ...
        _param = self._get_all_episode_comments_serialize(
            id=id,
            season=season,
            episode=episode,
            sort=sort,
    ...
    @validate_call
    def get_all_episode_comments_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    @validate_call
    def get_all_episode_comments_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    def _get_all_episode_comments_serialize(
        self,
        id,
        season,
        episode,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/episodes/{episode}/comments/{sort}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_all_episode_translations(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
        ...
        _param = self._get_all_episode_translations_serialize(
            id=id,
            season=season,
            episode=episode,
            language=language,
    ...
    @validate_call
    def get_all_episode_translations_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    @validate_call
    def get_all_episode_translations_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    def _get_all_episode_translations_serialize(
        self,
        id,
        season,
        episode,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/episodes/{episode}/translations/{language}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_all_people_for_an_episode(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
        ...
        _param = self._get_all_people_for_an_episode_serialize(
            id=id,
            season=season,
            episode=episode,
            trakt_api_version=trakt_api_version,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetAllPeopleForAnEpisode200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_all_people_for_an_episode_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAllPeopleForAnEpisode200Response]:
        """Get all people for an episode
    ...
    @validate_call
    def get_all_people_for_an_episode_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    def _get_all_people_for_an_episode_serialize(
        self,
        id,
        season,
        episode,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/episodes/{episode}/people",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_all_videos_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/episodes/{episode}/watching",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_episode_ratings(
        ...
        _param = self._get_episode_ratings_serialize(
            id=id,
            season=season,
            episode=episode,
            trakt_api_version=trakt_api_version,
    ...
    @validate_call
    def get_episode_ratings_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    @validate_call
    def get_episode_ratings_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    def _get_episode_ratings_serialize(
        self,
        id,
        season,
        episode,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/episodes/{episode}/ratings",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_episode_stats(
        ...
        _param = self._get_episode_stats_serialize(
            id=id,
            season=season,
            episode=episode,
            trakt_api_version=trakt_api_version,
    ...
    @validate_call
    def get_episode_stats_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    @validate_call
    def get_episode_stats_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    def _get_episode_stats_serialize(
        self,
        id,
        season,
        episode,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/episodes/{episode}/stats",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_lists_containing_this_episode(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
        ...
        _param = self._get_lists_containing_this_episode_serialize(
            id=id,
            season=season,
            episode=episode,
            type=type,
    ...
    @validate_call
    def get_lists_containing_this_episode_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    @validate_call
    def get_lists_containing_this_episode_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Trakt ID, Trakt slug, or IMDB ID")],
        season: Annotated[StrictInt, Field(description="season number")],
        episode: Annotated[StrictInt, Field(description="episode number")],
    ...
    def _get_lists_containing_this_episode_serialize(
        self,
        id,
        season,
        episode,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/shows/{id}/seasons/{season}/episodes/{episode}/lists/{type}/{sort}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
