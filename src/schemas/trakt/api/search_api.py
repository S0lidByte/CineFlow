...
class SearchApi:
    ...
    @validate_call
    def get_id_lookup_results(
        self,
        id_type: Annotated[StrictStr, Field(description="Type of ID to lookup.")],
        id: Annotated[StrictStr, Field(description="ID that matches with the type.")],
    ...
    ) -> List[GetIDLookupResults200ResponseInner]:
        ...
        :param id_type: Type of ID to lookup. (required)
        :type id_type: str
        :param id: ID that matches with the type. (required)
        :type id: str
        ...
        _param = self._get_id_lookup_results_serialize(
            id_type=id_type,
            id=id,
            type=type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetIDLookupResults200ResponseInner]",
        }
    ...
    @validate_call
    def get_id_lookup_results_with_http_info(
        self,
        id_type: Annotated[StrictStr, Field(description="Type of ID to lookup.")],
        id: Annotated[StrictStr, Field(description="ID that matches with the type.")],
        type: Annotated[Optional[StrictStr], Field(description="Search type.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetIDLookupResults200ResponseInner]]:
        """Get ID lookup results
    ...
    @validate_call
    def get_id_lookup_results_without_preload_content(
        self,
        id_type: Annotated[StrictStr, Field(description="Type of ID to lookup.")],
        id: Annotated[StrictStr, Field(description="ID that matches with the type.")],
        type: Annotated[Optional[StrictStr], Field(description="Search type.")] = None,
    ...
    def _get_id_lookup_results_serialize(
        self,
        id_type,
        id,
        type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/search/{id_type}/{id}",
    ...
    @validate_call
    def get_text_query_results(
        self,
        type: Annotated[StrictStr, Field(description="Search type.")],
        query: Annotated[StrictStr, Field(description="Search all text based fields.")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        trakt_api_key: Annotated[
        ...
        body: Annotated[
            Optional[StrictStr], Field(description="Specific text fields.")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_text_query_results_serialize(
            type=type,
            query=query,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[GetTextQueryResults200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def get_text_query_results_with_http_info(
        self,
        type: Annotated[StrictStr, Field(description="Search type.")],
        query: Annotated[StrictStr, Field(description="Search all text based fields.")],
        trakt_api_version: Annotated[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetTextQueryResults200ResponseInner]]:
        """Get text query results
    ...
    @validate_call
    def get_text_query_results_without_preload_content(
        self,
        type: Annotated[StrictStr, Field(description="Search type.")],
        query: Annotated[StrictStr, Field(description="Search all text based fields.")],
        trakt_api_version: Annotated[
    ...
    def _get_text_query_results_serialize(
        self,
        type,
        query,
        trakt_api_version,
