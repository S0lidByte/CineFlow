...
class SyncApi:
    ...
    def add_items_to_collection(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "201": "AddItemsToCollection201Response",
        }
    ...
    def add_items_to_collection_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddItemsToCollection201Response]:
        """Add items to collection
    ...
    def add_items_to_favorites(
        ...
        add_items_to_favorites_request: Optional[AddItemsToFavoritesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        #### &#128274; OAuth Required &#128513; Emojis  If the user only had 50 TV shows and movies to bring with them on a deserted island, what would they be? Apps should encourage user's to add favorites so the algorithm keeps getting better.  #### Notes  Each favorite can optionally accept a `notes` *(500 maximum characters)* field explaining why the user favorited the item.  #### Limits  If the user's favorite limit is exceeded, a `420` HTTP error code is returned. This limit applies to all users.  #### JSON POST Data  | Key | Type | Value | |---|---|---| | `movies` | array | Array of `movie` objects. (see examples &#8594;) | | `shows` | array | Array of `show` objects. |

        :param trakt_api_version: e.g. 2
        :type trakt_api_version: str
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param add_items_to_favorites_request:
        :type add_items_to_favorites_request: AddItemsToFavoritesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._add_items_to_favorites_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            add_items_to_favorites_request=add_items_to_favorites_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "201": "AddItemsToFavorites201Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def add_items_to_favorites_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddItemsToFavorites201Response]:
        """Add items to favorites
    ...
    @validate_call
    def add_items_to_favorites_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _add_items_to_favorites_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        add_items_to_favorites_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if add_items_to_favorites_request is not None:
            _body_params = add_items_to_favorites_request
    ...
    def add_items_to_watched_history(
        ...
        add_items_to_watched_history_request: Optional[
            AddItemsToWatchedHistoryRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        #### &#128274; OAuth Required  Add items to a user's watch history. Accepts shows, seasons, episodes and movies. If only a show is passed, all episodes for the show will be added. If seasons are specified, only episodes in those seasons will be added.  Send a `watched_at` UTC datetime to mark items as watched in the past. This is useful for syncing past watches from a media center.  > ### ☣️ 🅸🅼🅿🅾🆁🆃🅰🅽🆃 > _Please be careful with sending duplicate data. We don't verify the `item` + `watched_at` to ensure it's unique, it is up to your app to veify this and not send duplicate plays._  #### JSON POST Data  | Key | Type | Value | |---|---|---| | `movies` | array | Array of `movie` objects. (see examples &#8594;) | | `shows` | array | Array of `show` objects. | | `seasons` | array | Array of `season` objects. | | `episodes` | array | Array of `episode` objects. |  #### Media Object POST Data  | Key | Type | Value | |---|---|---| | item <span style=\"color:red;\">*</a> | object | `movie`, `show`, or `episode` object. | | `watched_at` | datetime | UTC datetime when the item was watched. Set to `released` to automatically use the initial release date + runtime *(episodes only)*. Set to `unknown` to mark the item as watched without a specific date. |
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "201": "AddItemsToWatchedHistory201Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def add_items_to_watched_history_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddItemsToWatchedHistory201Response]:
        """Add items to watched history
    ...
    def add_items_to_watchlist(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "201": "AddItemsToWatchlist201Response",
            "420": None,
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    def add_items_to_watchlist_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddItemsToWatchlist201Response]:
        """Add items to watchlist
    ...
    def add_new_ratings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddNewRatings201Response]:
        """Add new ratings
    ...
    def _get_favorites_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/sync/favorites/{type}/{sort_by}/{sort_how}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_last_activity(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetLastActivity200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def get_last_activity_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetLastActivity200Response]:
        """Get last activity
    ...
    def get_playback_progress(
        ...
        #### &#128274; OAuth Required &#128196; Pagination Optional  Whenever a scrobble is paused, the playback progress is saved. Use this progress to sync up playback across different media centers or apps. For example, you can start watching a movie in a media center, stop it, then resume on your tablet from the same spot. Each item will have the `progress` percentage between 0 and 100.  You can optionally specify a `type` to only get `movies` or `episodes`.  By default, all results will be returned. Pagination is optional and can be used for something like an \"on deck\" feature, or if you only need a limited data set.  > ### 🅽🅾🆃🅴 > _We only save playback progress for the last 6 months._
    ...
    def _get_watchlist_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/sync/watchlist/{type}/{sort_by}/{sort_how}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_items_from_collection(
        ...
        remove_items_from_collection_request: Optional[
            RemoveItemsFromCollectionRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "RemoveItemsFromCollection200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def remove_items_from_collection_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RemoveItemsFromCollection200Response]:
        """Remove items from collection
    ...
    @validate_call
    def remove_items_from_favorites(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        remove_items_from_favorites_request: Optional[
            RemoveItemsFromFavoritesRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        #### &#128274; OAuth Required  Remove items from a user's favorites. Apps should encourage user's to add favorites so the algorithm keeps getting better.  #### JSON POST Data  | Key | Type | Value | |---|---|---| | `movies` | array | Array of `movie` objects. (see examples &#8594;) | | `shows` | array | Array of `show` objects. |

        :param trakt_api_version: e.g. 2
        :type trakt_api_version: str
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param remove_items_from_favorites_request:
        :type remove_items_from_favorites_request: RemoveItemsFromFavoritesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._remove_items_from_favorites_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            remove_items_from_favorites_request=remove_items_from_favorites_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "RemoveItemsFromFavorites200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def remove_items_from_favorites_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RemoveItemsFromFavorites200Response]:
        """Remove items from favorites
    ...
    @validate_call
    def remove_items_from_favorites_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _remove_items_from_favorites_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        remove_items_from_favorites_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if remove_items_from_favorites_request is not None:
            _body_params = remove_items_from_favorites_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/sync/favorites/remove",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_items_from_history(
        ...
        remove_items_from_history_request: Optional[
            RemoveItemsFromHistoryRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "RemoveItemsFromHistory200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def remove_items_from_history_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RemoveItemsFromHistory200Response]:
        """Remove items from history
    ...
    def remove_items_from_watchlist(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "RemoveItemsFromWatchlist200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def remove_items_from_watchlist_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RemoveItemsFromWatchlist200Response]:
        """Remove items from watchlist
    ...
    def reorder_favorited_items(
        ...
        #### &#128274; OAuth Required  Reorder all items on a user's favorites by sending the updated `rank` of list item ids. Use the [**/sync/favorites**](#reference/sync/get-favorites) method to get all list item ids.
        ...
        _param = self._reorder_favorited_items_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ReorderFavoritedItems200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def reorder_favorited_items_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReorderFavoritedItems200Response]:
        """Reorder favorited items
    ...
    @validate_call
    def reorder_favorited_items_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _reorder_favorited_items_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/sync/favorites/reorder",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def reorder_watchlist_items(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ReorderWatchlistItems200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def reorder_watchlist_items_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReorderWatchlistItems200Response]:
        """Reorder watchlist items
    ...
    def update_a_favorite_item(
        ...
        #### &#128274; OAuth Required &#128513; Emojis  Update the `notes` on a single favorite item.
        ...
        _param = self._update_a_favorite_item_serialize(
    ...
    @validate_call
    def update_a_favorite_item_with_http_info(
        self,
        list_item_id: Annotated[StrictInt, Field(description="List Item ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def update_a_favorite_item_without_preload_content(
        self,
        list_item_id: Annotated[StrictInt, Field(description="List Item ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _update_a_favorite_item_serialize(
        self,
        list_item_id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="PUT",
            resource_path="/sync/favorites/{list_item_id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_a_watchlist_item(
        ...
        #### 🔥 VIP Enhanced &#128274; OAuth Required &#128513; Emojis  Update the `notes` on a single watchlist item.  #### Limits  If the user's note limit is exceeded, a `420` HTTP error code is returned. Use the [**/users/settings**](/reference/users/settings) method to get all limits for a user account. Upgrading to [**Trakt VIP**](https://trakt.tv/vip) allows for unlimited notes
        ...
        _param = self._update_a_watchlist_item_serialize(
            list_item_id=list_item_id,
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
            update_a_watchlist_item_request=update_a_watchlist_item_request,
    ...
    @validate_call
    def update_a_watchlist_item_with_http_info(
        self,
        list_item_id: Annotated[StrictInt, Field(description="List Item ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    @validate_call
    def update_a_watchlist_item_without_preload_content(
        self,
        list_item_id: Annotated[StrictInt, Field(description="List Item ID")],
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
    ...
    def _update_a_watchlist_item_serialize(
        self,
        list_item_id,
        trakt_api_version,
        trakt_api_key,
        ...
        return self.api_client.param_serialize(
            method="PUT",
            resource_path="/sync/watchlist/{list_item_id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_favorites(
        ...
        update_favorites_request: Optional[UpdateFavoritesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        #### &#128274; OAuth Required  Update the favorites list by sending 1 or more parameters.  #### JSON POST Data  | Key | Type | Value | |---|---|---|---| | `description` | string | Description for the favorites list. | | `sort_by` | string | `rank`, `added`, `title`, `released`, `runtime`, `popularity`, `random`, `percentage`, `imdb_rating`, `tmdb_rating`, `rt_tomatometer`, `rt_audience`, `metascore`, `votes`, `imdb_votes`, `tmdb_votes`, `my_rating`, `watched`, `collected` | | `sort_how` | string | `asc`, `desc` |

        :param trakt_api_version: e.g. 2
        :type trakt_api_version: str
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param update_favorites_request:
        :type update_favorites_request: UpdateFavoritesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_favorites_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_favorites_request is not None:
            _body_params = update_favorites_request
    ...
    def update_watchlist(
        ...
        update_watchlist_request: Optional[UpdateWatchlistRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        #### &#128274; OAuth Required  Update the watchlist by sending 1 or more parameters.  #### JSON POST Data  | Key | Type | Value | |---|---|---|---| | `description` | string | Description for the watchlist. | | `sort_by` | string | `rank`, `added`, `title`, `released`, `runtime`, `popularity`, `random`, `percentage`, `imdb_rating`, `tmdb_rating`, `rt_tomatometer`, `rt_audience`, `metascore`, `votes`, `imdb_votes`, `tmdb_votes`, `my_rating`, `watched`, `collected` | | `sort_how` | string | `asc`, `desc` |

        :param trakt_api_version: e.g. 2
        :type trakt_api_version: str
        :param trakt_api_key: e.g. [client_id]
        :type trakt_api_key: str
        :param update_watchlist_request:
        :type update_watchlist_request: UpdateWatchlistRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_watchlist_serialize(
            trakt_api_version=trakt_api_version,
            trakt_api_key=trakt_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "UpdateWatchlist200Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def update_watchlist_with_http_info(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateWatchlist200Response]:
        """Update watchlist
    ...
    @validate_call
    def update_watchlist_without_preload_content(
        self,
        trakt_api_version: Annotated[
            Optional[StrictStr], Field(description="e.g. 2")
        ] = None,
    ...
    def _update_watchlist_serialize(
        self,
        trakt_api_version,
        trakt_api_key,
        ...
        # process the form parameters
        # process the body parameter
        if update_watchlist_request is not None:
            _body_params = update_watchlist_request
