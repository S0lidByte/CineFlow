...
class LunaSeaSettingsOptions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["webhookUrl", "profileName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"webhookUrl": obj.get("webhookUrl"), "profileName": obj.get("profileName")}
        )
        return _obj
