...
class SettingsCacheGet200ResponseImageCacheTmdb(BaseModel):
    """
    SettingsCacheGet200ResponseImageCacheTmdb
    """  # noqa: E501

    size: Optional[Union[StrictFloat, StrictInt]] = None
    image_count: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="imageCount"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"size": obj.get("size"), "imageCount": obj.get("imageCount")}
        )
        return _obj
