...
class MainSettings(BaseModel):
    ...
    application_title: Optional[StrictStr] = Field(
        default=None, alias="applicationTitle"
    )
    ...
    partial_requests_enabled: Optional[StrictBool] = Field(
        default=None, alias="partialRequestsEnabled"
    )
    ...
    default_permissions: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="defaultPermissions"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "appLanguage": obj.get("appLanguage"),
                "applicationTitle": obj.get("applicationTitle"),
                "applicationUrl": obj.get("applicationUrl"),
                "trustProxy": obj.get("trustProxy"),
                "csrfProtection": obj.get("csrfProtection"),
                "hideAvailable": obj.get("hideAvailable"),
                "partialRequestsEnabled": obj.get("partialRequestsEnabled"),
                "localLogin": obj.get("localLogin"),
                "newPlexLogin": obj.get("newPlexLogin"),
