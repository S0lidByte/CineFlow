...
class PersonResult(BaseModel):
    ...
    known_for: Optional[List[PersonResultKnownForInner]] = Field(
        default=None, alias="knownFor"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "knownFor": (
                    [
                        PersonResultKnownForInner.from_dict(_item)
                        for _item in obj["knownFor"]
                    ]
                    if obj.get("knownFor") is not None
                    else None
                ),
            }
        )
