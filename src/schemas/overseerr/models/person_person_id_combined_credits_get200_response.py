...
class PersonPersonIdCombinedCreditsGet200Response(BaseModel):
    ...
    cast: Optional[List[CreditCast]] = None
    crew: Optional[List[CreditCrew]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "cast": (
                    [CreditCast.from_dict(_item) for _item in obj["cast"]]
                    if obj.get("cast") is not None
                    else None
                ),
                "crew": (
                    [CreditCrew.from_dict(_item) for _item in obj["crew"]]
