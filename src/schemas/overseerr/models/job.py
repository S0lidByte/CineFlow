...
class Job(BaseModel):
    ...
    next_execution_time: Optional[StrictStr] = Field(
        default=None, alias="nextExecutionTime"
    )
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(["process", "command"]):
    ...
    def interval_validate_enum(cls, value):
        ...
        if value not in set(["short", "long", "fixed"]):
