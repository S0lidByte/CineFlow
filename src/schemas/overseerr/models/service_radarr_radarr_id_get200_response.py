...
class ServiceRadarrRadarrIdGet200Response(BaseModel):
    """
    ServiceRadarrRadarrIdGet200Response
    """  # noqa: E501

    server: Optional[RadarrSettings] = None
    profiles: Optional[ServiceProfile] = None
    __properties: ClassVar[List[str]] = ["server", "profiles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "server": (
                    RadarrSettings.from_dict(obj["server"])
                    if obj.get("server") is not None
                    else None
                ),
                "profiles": (
                    ServiceProfile.from_dict(obj["profiles"])
