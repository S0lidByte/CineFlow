...
class UserUserIdSettingsPermissionsPostRequest(BaseModel):
    """
    UserUserIdSettingsPermissionsPostRequest
    """  # noqa: E501

    permissions: Union[StrictFloat, StrictInt]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"permissions": obj.get("permissions")})
        return _obj
