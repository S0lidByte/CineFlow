...
class SettingsAboutGet200Response(BaseModel):
    ...
    total_requests: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="totalRequests"
    )
    total_media_items: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="totalMediaItems"
    )
