...
class Configuration:
    ...
    conf = schemas.overseerr.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "http://localhost:5055/api/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("schemas.overseerr")
        ...
        return [
            {
                ...
                "variables": {
                    "server": {
                        "description": "No description provided",
                        "default_value": "http://localhost:5055",
                    }
                },
            }
        ]
