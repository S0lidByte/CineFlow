...
class CompanyType(BaseModel):
    ...
    company_type_name: Optional[StrictStr] = Field(
        default=None, alias="companyTypeName"
    )
    __properties: ClassVar[List[str]] = ["companyTypeId", "companyTypeName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "companyTypeId": obj.get("companyTypeId"),
                "companyTypeName": obj.get("companyTypeName"),
            }
        )
        return _obj
