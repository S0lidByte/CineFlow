...
class TagOption(BaseModel):
    ...
    tag: Optional[StrictInt] = None
    tag_name: Optional[StrictStr] = Field(default=None, alias="tagName")
    __properties: ClassVar[List[str]] = ["helpText", "id", "name", "tag", "tagName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TagOption from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TagOption from a dict"""
        if obj is None:
            return None
