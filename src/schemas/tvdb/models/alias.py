...
class Alias(BaseModel):
    ...
    language: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None,
    ...
    name: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="A string containing the alias itself."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"language": obj.get("language"), "name": obj.get("name")}
        )
        return _obj
