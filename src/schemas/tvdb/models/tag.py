...
class Tag(BaseModel):
    ...
    allows_multiple: Optional[StrictBool] = Field(default=None, alias="allowsMultiple")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "allowsMultiple": obj.get("allowsMultiple"),
                "helpText": obj.get("helpText"),
                "id": obj.get("id"),
                "name": obj.get("name"),
                "options": (
                    [TagOption.from_dict(_item) for _item in obj["options"]]
