...
import schemas.tvdb.models
from schemas.tvdb import rest
from schemas.tvdb.api_response import ApiResponse
from schemas.tvdb.api_response import T as ApiResponseT
from schemas.tvdb.configuration import Configuration
from schemas.tvdb.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(schemas.tvdb.models, klass)
