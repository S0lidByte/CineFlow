...
class NotificationResource(BaseModel):
    ...
    on_health_restored: Optional[StrictBool] = Field(
        default=None, alias="onHealthRestored"
    )
    on_application_update: Optional[StrictBool] = Field(
        default=None, alias="onApplicationUpdate"
    )
    supports_on_grab: Optional[StrictBool] = Field(default=None, alias="supportsOnGrab")
    include_manual_grabs: Optional[StrictBool] = Field(
        default=None, alias="includeManualGrabs"
    )
    supports_on_health_issue: Optional[StrictBool] = Field(
        default=None, alias="supportsOnHealthIssue"
    )
    supports_on_health_restored: Optional[StrictBool] = Field(
        default=None, alias="supportsOnHealthRestored"
    )
    include_health_warnings: Optional[StrictBool] = Field(
        default=None, alias="includeHealthWarnings"
    )
    supports_on_application_update: Optional[StrictBool] = Field(
        default=None, alias="supportsOnApplicationUpdate"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "tags": obj.get("tags"),
                "presets": (
                    [NotificationResource.from_dict(_item) for _item in obj["presets"]]
                ...
                "includeManualGrabs": obj.get("includeManualGrabs"),
