...
class AppProfileResource(BaseModel):
    ...
    enable_automatic_search: Optional[StrictBool] = Field(
        default=None, alias="enableAutomaticSearch"
    )
    enable_interactive_search: Optional[StrictBool] = Field(
        default=None, alias="enableInteractiveSearch"
    )
