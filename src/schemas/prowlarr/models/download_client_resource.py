...
class DownloadClientResource(BaseModel):
    ...
    presets: Optional[List[DownloadClientResource]] = None
    enable: Optional[StrictBool] = None
    protocol: Optional[DownloadProtocol] = None
    priority: Optional[StrictInt] = None
    categories: Optional[List[DownloadClientCategory]] = None
    supports_categories: Optional[StrictBool] = Field(
        default=None, alias="supportsCategories"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "presets": (
                    [
                        DownloadClientResource.from_dict(_item)
                        for _item in obj["presets"]
                    ]
                ...
                "categories": (
                    [
                        DownloadClientCategory.from_dict(_item)
                        for _item in obj["categories"]
                    ]
                    if obj.get("categories") is not None
                    else None
                ),
                "supportsCategories": obj.get("supportsCategories"),
            }
        )
        return _obj
...
DownloadClientResource.model_rebuild(raise_errors=False)
