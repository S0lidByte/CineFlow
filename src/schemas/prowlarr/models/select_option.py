...
class SelectOption(BaseModel):
    ...
    parent_value: Optional[StrictInt] = Field(default=None, alias="parentValue")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.parent_value is None and "parent_value" in self.model_fields_set:
        ...
        _obj = cls.model_validate(
            {
                ...
                "order": obj.get("order"),
                "hint": obj.get("hint"),
                "parentValue": obj.get("parentValue"),
            }
        )
        return _obj
