...
class IndexerProxyResource(BaseModel):
    ...
    presets: Optional[List[IndexerProxyResource]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "tags": obj.get("tags"),
                "presets": (
                    [IndexerProxyResource.from_dict(_item) for _item in obj["presets"]]
...
IndexerProxyResource.model_rebuild(raise_errors=False)
