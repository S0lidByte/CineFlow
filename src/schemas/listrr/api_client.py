...
import schemas.listrr.models
from schemas.listrr import rest
from schemas.listrr.api_response import ApiResponse
from schemas.listrr.api_response import T as ApiResponseT
from schemas.listrr.configuration import Configuration
from schemas.listrr.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(schemas.listrr.models, klass)
